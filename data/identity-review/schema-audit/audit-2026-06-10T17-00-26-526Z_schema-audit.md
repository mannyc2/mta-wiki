...
run_id: 2026-06-10T17-00-26-526Z_schema-audit
generated_at: 2026-06-10T17:00:26.526Z

Corpus: 3957 submissions (accepted 3792 / rejected 165) across 12 observation kinds.
Canonical records in audit projection: 3440.
...
submissions: 1272 (accepted 1228 / rejected 44); canonical records: 1219

### Fields

| field | anchor | all | acc | canon | coverage | value_kind | distinct | classification | samples |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| metric_name | yes | 1272 | 1228 | 1219 | 1.00 | scalar_string | 714 | free_text | travel_time, bus_travel_time, travel_time_change_pct, bus_travel_time… |
| raw_value_text | yes | 1253 | 1209 | 1200 | 0.99 | scalar_string | 1102 | free_text | less than 4 mph in some segments, 0, 14, 2, 84, 86%, +38%, +8% |
| value | yes | 1209 | 1193 | 1185 | 0.95 | number | 0 | numeric |  |
| unit | — | 1085 | 1057 | 1071 | 0.85 | scalar_string | 105 | free_text | percent, minutes, mph, people, miles, routes, dollars, vehicles |
| scope | — | 475 | 455 | 455 | 0.37 | scalar_string | 182 | free_text | New York City, Study area, Brooklyn, CBD Overall, 34th Street corrido… |
| period | — | 411 | 407 | 407 | 0.32 | scalar_string | 99 | free_text | school_months, 2025, 2022-2023, May 2025, summer_months, 2019-2023, D… |
| unit_normalized | — | 357 | 346 | 1071 | 0.28 | object | 0 | structured |  |
| direction | — | 289 | 285 | 280 | 0.23 | scalar_string | 39 | free_text | neutral, decrease, increase, NB/EB, SB/WB, northbound, improvement, t… |
| description | — | 259 | 252 | 251 | 0.20 | scalar_string | 252 | free_text | Bus speed in slowest segments of 116th Street study area, Grade A thr… |
| route_label | — | 155 | 155 | 155 | 0.12 | scalar_string | 14 | free_text | M86, B44 SBS, M15 SBS, S79 SBS, Bx41 SBS, B60, Bx18A/B, M116 |
| mode | — | 83 | 79 | 79 | 0.07 | scalar_string | 15 | free_text | bus, subway, pedestrian, motor_vehicle_occupant, paratransit, bicycli… |
| value_max | yes | 79 | 68 | 67 | 0.06 | mixed | 2 | enum_candidate | 2026-05-11T00:00:00.000, S79+ |
| value_min | yes | 76 | 69 | 68 | 0.06 | mixed | 2 | enum_candidate | 2019-10-07T00:00:00.000, B11 |
| year | — | 73 | 73 | 73 | 0.06 | mixed | 1 | numeric | 2022 |
| context | — | 71 | 69 | 69 | 0.06 | scalar_string | 53 | free_text | Brooklyn, Brooklyn bus network, Brooklyn residents, February 2015, 6:… |
| comparison | — | 66 | 66 | 66 | 0.05 | mixed | 20 | free_text | May 2019 vs May 2022, post_vs_pre_sbs, pre_sbs, post_sbs, May_2014_to… |
| mode_normalized | — | 63 | 59 | 79 | 0.05 | object | 0 | structured |  |
| time_period | — | 45 | 42 | 42 | 0.04 | scalar_string | 15 | free_text | Daily, Dec-July (2021-2022), Dec-July average (2017-2018, 2018-2019,… |
| route | — | 44 | 38 | 38 | 0.03 | scalar_string | 27 | free_text | B44 SBS, B44 Limited, B1, B44, B49, B44 Local, Bx4, B44 Total |
| day_type | — | 31 | 28 | 28 | 0.02 | scalar_string | 5 | enum_candidate | weekday, saturday, sunday, daily, weekend |
| direction_normalized | — | 30 | 29 | 280 | 0.02 | object | 0 | structured |  |
| scenario | — | 29 | 29 | 29 | 0.02 | scalar_string | 5 | enum_candidate | existing_network, increase, proposed_network, draft_plan, projected b… |
...
| category | — | 19 | 17 | 17 | 0.01 | scalar_string | 14 | free_text | bus_frequency, bus_in_motion, bus_speed, stopped_at_bus_stops, very_s… |
...
| service_type | — | 16 | 16 | 16 | 0.01 | scalar_string | 6 | enum_candidate | all-day frequent, express, Select Bus Service, Local, express bus, lo… |
| comparison_normalized | — | 14 | 14 | 65 | 0.01 | object | 0 | structured |  |
| time_period_normalized | — | 14 | 11 | 42 | 0.01 | object | 0 | structured |  |
| day_type_normalized | — | 13 | 10 | 28 | 0.01 | object | 0 | structured |  |
...
| service_type_normalized | — | 7 | 7 | 16 | 0.01 | object | 0 | structured |  |
| comparison_period | — | 6 | 6 | 6 | 0.00 | scalar_string | 2 | enum_candidate | November 2024, October 2025 |
| existing_frequency_category | — | 6 | 0 | 0 | 0.00 | scalar_string | 2 | enum_candidate | 15-or-better, 30-or-better |
| perception | — | 6 | 4 | 4 | 0.00 | scalar_string | 3 | enum_candidate | faster, more_frequent, much_safer |
| pilot_value | — | 6 | 6 | 6 | 0.00 | number | 0 | numeric |  |
| pre_pilot_value | — | 6 | 6 | 6 | 0.00 | number | 0 | numeric |  |
| proposed_frequency_category | — | 6 | 0 | 0 | 0.00 | scalar_string | 3 | enum_candidate | 8-or-better, 15-or-better, 8-or-better (at Hunts Point only) |
...
| scenario_normalized | — | 5 | 5 | 29 | 0.00 | object | 0 | structured |  |
...
| benefit_denominator_stated | — | 0 | 0 | 2 | 0.00 | empty | 0 | sparse |  |
| borough_normalized | — | 0 | 0 | 16 | 0.00 | empty | 0 | sparse |  |
| cost_type | — | 0 | 0 | 9 | 0.00 | empty | 0 | sparse |  |
| demographic_group_normalized | — | 0 | 0 | 24 | 0.00 | empty | 0 | sparse |  |
| funding_source | — | 0 | 0 | 5 | 0.00 | empty | 0 | sparse |  |
| time_horizon | — | 0 | 0 | 4 | 0.00 | empty | 0 | sparse |  |

### Enum candidates (proposed closures, derived from corpus)

- **value_max** (79 all / 68 accepted / 67 canonical, 2 distinct, singletons 1/2, open): `2026-05-11T00:00:00.000` | `S79+`
  - counts: 2026-05-11T00:00:00.000×2
- **value_min** (76 all / 69 accepted / 68 canonical, 2 distinct, singletons 1/2, open): `2019-10-07T00:00:00.000` | `B11`
  - counts: 2019-10-07T00:00:00.000×2
- **day_type** (31 all / 28 accepted / 28 canonical, 5 distinct, singletons 1/5, open): `daily` | `saturday` | `sunday` | `weekday` | `weekend`
  - counts: weekday×20, saturday×5, sunday×3, daily×2
  - accepted counts: weekday×17, saturday×5, sunday×3, daily×2
  - canonical counts: weekday×17, saturday×5, sunday×3, daily×2
- **scenario** (29 all / 29 accepted / 29 canonical, 5 distinct, singletons 1/5, open): `draft_plan` | `existing_network` | `increase` | `projected benefit` | `proposed_network`
  - counts: existing_network×8, increase×8, proposed_network×8, draft_plan×4
  - accepted counts: existing_network×8, increase×8, proposed_network×8, draft_plan×4
  - canonical counts: existing_network×8, increase×8, proposed_network×8, draft_plan×4
...
- **service_type** (16 all / 16 accepted / 16 canonical, 6 distinct, singletons 2/6, open): `all-day frequent` | `express` | `express bus` | `local` | `Local` | `Select Bus Service`
  - counts: all-day frequent×5, express×4, Select Bus Service×3, Local×2
  - accepted counts: all-day frequent×5, express×4, Select Bus Service×3, Local×2
  - canonical counts: all-day frequent×5, express×4, Select Bus Service×3, Local×2
...
`_merged_field_values`, `baseline_year`, `benefit_denominator_stated`, `borough`, `borough_normalized`, `category`, `change`, `change_mom_pct`, `change_unit`, `change_yoy_pct`, `code`, `column`, `comparison`, `comparison_normalized`, `comparison_period`, `context`, `cost_type`, `currency`, `date`, `date_normalized`, `day_type`, `day_type_normalized`, `days`, `demographic`, `demographic_group`, `demographic_group_normalized`, `denominator`, `description`, `direction`, `direction_normalized`, `entity`, `existing_frequency_category`, `existing_stop_spacing_ft`, `fine_period_months`, `fine_tier`, `fiscal_year`, `frequency`, `funding_source`, `goal`, `installed_since`, `label`, `location`, `location_normalized`, `meaning`, `mode`, `mode_normalized`, `neighborhood`, `note`, `numerator`, `perception`, `period`, `pilot_value`, `pre_pilot_value`, `proposed_frequency_category`, `proposed_rush_routes`, `proposed_stop_spacing_ft`, `provider`, `route`, `route_label`, `routes`, `scenario`, `scenario_normalized`, `scope`, `service_type`, `service_type_normalized`, `source_system`, `stops_removed`, `subject`, `target`, `target_description`, `temporal_context`, `time_horizon`, `time_period`, `time_period_normalized`, `total_stops`, `unit`, `unit_normalized`, `units`, `value_direction`, `value_note`, `value_unit`, `values`, `within_minutes`, `year`, `year_over_year_change`
...
- (label ×2) Bus travel time - Dwell Time 38%
- (label ×2) Bus travel time - In Motion 40%
- (label ×2) Bus travel time - Waiting at Signals 22%
...
- (raw_text ×3) below 5 MPH in Downtown Brooklyn
...
- (raw_text ×2) +38%
- (raw_text ×2) +46%
- (raw_text ×2) 16,000 passengers per day
- (raw_text ×2) 17,000 passengers per day
- (raw_text ×2) 2.2pp
- (raw_text ×2) 20% travel time savings
- (raw_text ×2) 21 routes in Brooklyn which do not meet this threshold and operate at headways greater than 15 minu…
- (raw_text ×2) About 62 percent of Brooklyn residents rely on public transit for their daily commutes and at least…
- (raw_text ×2) An additional 19 routes operate every 15 minutes or better.
- (raw_text ×2) Approximately 19 percent of Brooklyn bus customers are seniors or people with disabilities.
- (raw_text ×2) Bus ridership in Brooklyn fell 14 percent from 2016 to 2019.
- (raw_text ×2) Bus service feels... More frequent 57%
- (raw_text ×2) bus speed increases ranging from 15% to 31%
- (raw_text ×2) Bus speeds average 7 MPH across the corridor, and below 5 MPH in Downtown Brooklyn.
...
- (raw_text ×2) Dwell Time 38% 10 minutes, 41 seconds

## relation

submissions: 637 (accepted 589 / rejected 48); canonical records: 807

### Fields

| field | anchor | all | acc | canon | coverage | value_kind | distinct | classification | samples |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| relation_kind | yes | 637 | 589 | 807 | 1.00 | scalar_string | 127 | free_text | has_timeline_event, serves_route, has_treatment, in_development_for,… |
| subject_local_observation_id | yes | 637 | 589 | 807 | 1.00 | scalar_string | 176 | free_text | project_ace_automated_camera_enforcement, project_tsp_expansion_2017,… |
| object_local_observation_id | yes | 633 | 589 | 807 | 0.99 | scalar_string | 509 | free_text | entity_nyc_dot, entity_mta_nyct, entity_nyc-dot, project_lga_access_a… |
| description | — | 334 | 295 | 294 | 0.52 | scalar_string | 300 | free_text | B82 in Southern Brooklyn in development for TSP, Bx12 SBS on Fordham… |
| relation_family | — | 130 | 126 | 807 | 0.20 | scalar_string | 11 | enum_candidate | timeline_context, treatment_context, other, corridor_scope, route_sco… |
| raw_relation_kind | — | 6 | 6 | 29 | 0.01 | scalar_string | 2 | enum_candidate | affects_route, has_partner_agency |
...
| as_of_date | — | 0 | 0 | 675 | 0.00 | empty | 0 | sparse |  |
| assertion_status | — | 0 | 0 | 807 | 0.00 | empty | 0 | sparse |  |
| derivation_confidence | — | 0 | 0 | 222 | 0.00 | empty | 0 | sparse |  |
| derivation_rule | — | 0 | 0 | 222 | 0.00 | empty | 0 | sparse |  |
| derived_from_payload_field | — | 0 | 0 | 222 | 0.00 | empty | 0 | sparse |  |
| derived_from_payload_value | — | 0 | 0 | 222 | 0.00 | empty | 0 | sparse |  |
| derived_from_record_id | — | 0 | 0 | 222 | 0.00 | empty | 0 | sparse |  |
| derived_relation | — | 0 | 0 | 222 | 0.00 | empty | 0 | sparse |  |
| object_id | — | 0 | 0 | 807 | 0.00 | empty | 0 | sparse |  |
| object_record_kind | — | 0 | 0 | 222 | 0.00 | empty | 0 | sparse |  |
| subject_id | — | 0 | 0 | 807 | 0.00 | empty | 0 | sparse |  |
| subject_record_kind | — | 0 | 0 | 222 | 0.00 | empty | 0 | sparse |  |

### Enum candidates (proposed closures, derived from corpus)

- **relation_family** (130 all / 126 accepted / 807 canonical, 11 distinct, singletons 0/11, open): `agency_role` | `claim_context` | `corridor_scope` | `location_scope` | `metric_context` | `other` | `partnership_engagement` | `publication_role` | `route_scope` | `timeline_context` | `treatment_context`
  - counts: timeline_context×35, treatment_context×23, other×16, corridor_scope×15, route_scope×14, partnership_engagement×6, agency_role×5, location_scope×5, metric_context×5, claim_context×3, publication_role×3
  - accepted counts: timeline_context×35, treatment_context×23, corridor_scope×15, other×14, route_scope×14, partnership_engagement×6, location_scope×5, metric_context×5, agency_role×4, claim_context×3, publication_role×2
  - canonical counts: timeline_context×157, route_scope×145, metric_context×118, corridor_scope×84, treatment_context×64, agency_role×44, publication_role×43, claim_context×31, partnership_engagement×29, other×24, governance_legal×11, location_scope×11, program_project_scope×11, data_reporting×10, dependency_or_reference×9, organization_hierarchy×9, ownership_role×4, funding_award×3
- **raw_relation_kind** (6 all / 6 accepted / 29 canonical, 2 distinct, singletons 0/2, open): `affects_route` | `has_partner_agency`
  - counts: affects_route×4, has_partner_agency×2
  - accepted counts: affects_route×4, has_partner_agency×2
  - canonical counts: has_treatment_component×16, affects_route×4, has_partner_agency×3, has_corridor×2

### Keys outside declared anchors

These payload keys are not in `REQUIRED_PAYLOAD_ANCHORS` for this kind. High-coverage keys are schema-promotion candidates; rare ones are escape-hatch (`raw_*`/`notes`/`other_*`) candidates.

`as_of_date`, `assertion_status`, `contractor`, `derivation_confidence`, `derivation_rule`, `derived_from_payload_field`, `derived_from_payload_value`, `derived_from_record_id`, `derived_relation`, `description`, `hotline`, `new_location`, `new_location_normalized`, `object_id`, `object_record_kind`, `old_location`, `old_location_normalized`, `raw_relation_kind`, `relation_family`, `routes`, `routes_affected`, `subject_id`, `subject_record_kind`

### Repeated labels / raw_text (source_labels candidates)

- (label ×3) Source published by NYC DOT
- (label ×2) 34th Street Transitway Project uses 34th Street Corridor
...
- (label ×2) Project Enforcement: MTA/DOT/NYPD
...
- (raw_text ×2) M16/M34 stations along Transitway Corridor
- (raw_text ×2) M16/M34 stations shown on Transitway Corridor map
...
submissions: 471 (accepted 449 / rejected 22); canonical records: 447

### Fields

| field | anchor | all | acc | canon | coverage | value_kind | distinct | classification | samples |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| claim_text | yes | 440 | 421 | 419 | 0.93 | scalar_string | 422 | free_text | A 2025 report assessing corridor-level speed impacts of different bus… |
| description | yes | 233 | 219 | 219 | 0.49 | scalar_string | 211 | free_text | Key concern raised during door-to-door business outreach on May 17, 2… |
| statement | yes | 106 | 101 | 100 | 0.23 | scalar_string | 91 | free_text | monitoring_finding, business_concern, Data & Analytics team builds da… |
| data_type | — | 76 | 70 | 70 | 0.16 | scalar_string | 30 | free_text | text, plan, number, existing_condition, screening result, multiline,… |
...
| change_type | — | 30 | 30 | 30 | 0.06 | scalar_string | 16 | free_text | improvement, reroute, maintain_existing, new_route, no_change, servic… |
| non_null_count | — | 29 | 27 | 27 | 0.06 | number | 0 | numeric |  |
| null_count | — | 29 | 27 | 27 | 0.06 | number | 0 | numeric |  |
| data_type_normalized | — | 23 | 20 | 70 | 0.05 | object | 0 | structured |  |
...
| change_type_normalized | — | 9 | 9 | 30 | 0.02 | object | 0 | structured |  |
| scope | — | 9 | 9 | 9 | 0.02 | scalar_string | 6 | enum_candidate | 34th Street, 34th Street Transitway Concept, Fifth Avenue/Madison Ave… |
| text | yes | 9 | 9 | 9 | 0.02 | scalar_string | 9 | free_text | 248 people were injured in crashes in the CB10 study area on 116th St… |
| routes | — | 8 | 8 | 8 | 0.02 | array_string | 12 | free_text | Bx40, Bx42, Bx36, B44 SBS, Bx15, Bx28, Bx38, Bx5 |
| year | — | 7 | 7 | 7 | 0.01 | mixed | 1 | numeric | 2022 |
...
- **scope** (9 all / 9 accepted / 9 canonical, 6 distinct, singletons 3/6, open): `34th Street` | `34th Street Transitway Concept` | `at Hunts Point only` | `Fifth Avenue/Madison Avenue corridor` | `July 2016 customer survey` | `M86 Local before SBS`
  - counts: 34th Street×2, 34th Street Transitway Concept×2, Fifth Avenue/Madison Avenue corridor×2
  - accepted counts: 34th Street×2, 34th Street Transitway Concept×2, Fifth Avenue/Madison Avenue corridor×2
  - canonical counts: 34th Street×2, 34th Street Transitway Concept×2, Fifth Avenue/Madison Avenue corridor×2
...
- (label ×2) Alternatives Passing Primary Screening
...
- (label ×2) Definition of Bus Rapid Transit (BRT)
- (label ×2) Developing processes to automate dataset publishing
- (label ×2) Direction column
- (label ×2) Failed Alternatives - Primary Screening
- (label ×2) Failed Alternatives (Streetcar, LRT, AGT, Heavy Rail)
...
- (raw_text ×2) High quality surface transit - faster and more reliable. Physical and operational improvements to b…
...
- (raw_text ×2) No Build, TSM, and BRT Alternatives passed Primary Screening
- (raw_text ×2) Streetcar, Light Rail Transit, Automated Guideway Transit, and Heavy Rail alternatives failed prima…
- (raw_text ×2) Streetcar, LRT, AGT, and Heavy Rail alternatives failed primary screening

## route

submissions: 315 (accepted 305 / rejected 10); canonical records: 138

### Fields

| field | anchor | all | acc | canon | coverage | value_kind | distinct | classification | samples |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| route_id | yes | 274 | 264 | 130 | 0.87 | scalar_string | 167 | free_text | B44, M15, B82, Bx6, M7, M86, B44 SBS, B46 SBS |
| route_label | yes | 256 | 250 | 124 | 0.81 | scalar_string | 175 | free_text | Q43, Bx36, M116, B25, B26, B42, B60, B62 |
| borough | — | 145 | 139 | 92 | 0.46 | mixed | 5 | enum_candidate | Manhattan, Brooklyn, Bronx, Queens, Staten Island |
| description | — | 139 | 133 | 77 | 0.44 | scalar_string | 102 | free_text | Bronx-Manhattan express bus route serving 116th Street study area, Bu… |
| route_name | yes | 124 | 120 | 68 | 0.39 | scalar_string | 108 | free_text | M15, M86, Nostrand/Rogers Avenues, Q43, B82, Bx6, Bx6 Local, Bx6 SBS |
| route_type | — | 107 | 98 | 56 | 0.34 | scalar_string | 18 | free_text | local bus, Select Bus Service, express bus, Local, bus, SBS, express_… |
| route_type_normalized | — | 89 | 80 | 56 | 0.28 | scalar_string | 10 | enum_candidate | local, select_bus_service, express, bus, crosstown_sbs, limited_stop,… |
| service_variant | — | 74 | 70 | 52 | 0.23 | scalar_string | 4 | enum_candidate | local, sbs, express, limited_stop |
| borough_normalized | — | 67 | 61 | 92 | 0.21 | scalar_string | 5 | enum_candidate | manhattan, brooklyn, bronx, queens, staten_island |
| route | yes | 67 | 67 | 40 | 0.21 | scalar_string | 57 | free_text | B25, B26, B42, B62, BX19, BX35, BX36, Q43 |
| streets | — | 65 | 65 | 62 | 0.21 | scalar_string | 61 | free_text | Lefferts Blvd, 3 Av / Lexington Av, Bay Pkwy / Kings Hwy / Flatlands… |
| note | — | 28 | 28 | 27 | 0.09 | scalar_string | 5 | free_text | ABLE cameras operated on this route through 2023, in 60-day warning p… |
| program | — | 23 | 23 | 23 | 0.07 | scalar_string | 2 | enum_candidate | ABLE, Transit Signal Priority |
| routes | yes | 21 | 21 | 20 | 0.07 | array_string | 25 | free_text | M101, M102, M103, M14A, M14D, M98, Q1, Q10 |
| mode | — | 10 | 10 | 10 | 0.03 | scalar_string | 2 | enum_candidate | subway, bus |
| boroughs | — | 9 | 8 | 8 | 0.03 | array_string | 3 | enum_candidate | Bronx, Manhattan, Queens |
| boroughs_normalized | — | 9 | 8 | 8 | 0.03 | array_string | 3 | enum_candidate | bronx, manhattan, queens |
...
| _merged_field_values | — | 0 | 0 | 43 | 0.00 | empty | 0 | sparse |  |
| internal_route_id | — | 0 | 0 | 10 | 0.00 | empty | 0 | sparse |  |
| route_id_authority | — | 0 | 0 | 10 | 0.00 | empty | 0 | sparse |  |

### Enum candidates (proposed closures, derived from corpus)

- **borough** (145 all / 139 accepted / 92 canonical, 5 distinct, singletons 0/5, **saturated → closure candidate**): `Bronx` | `Brooklyn` | `Manhattan` | `Queens` | `Staten Island`
  - counts: Manhattan×47, Brooklyn×37, Bronx×32, Queens×22, Staten Island×8
  - accepted counts: Manhattan×46, Brooklyn×33, Bronx×31, Queens×22, Staten Island×8
  - canonical counts: Manhattan×30, Bronx×21, Brooklyn×19, Queens×17, Staten Island×6
- **route_type_normalized** (89 all / 80 accepted / 56 canonical, 10 distinct, singletons 4/10, open): `brt` | `brt_bus` | `bus` | `crosstown_sbs` | `express` | `limited_stop` | `local` | `local_limited` | `local_select_bus_service` | `select_bus_service`
  - counts: local×32, select_bus_service×25, express×13, bus×9, crosstown_sbs×3, limited_stop×3
  - accepted counts: local×29, select_bus_service×25, express×12, bus×8, limited_stop×3
  - canonical counts: local×22, select_bus_service×15, express×7, bus×6, limited_stop×4, rush×2
- **service_variant** (74 all / 70 accepted / 52 canonical, 4 distinct, singletons 0/4, open): `express` | `limited_stop` | `local` | `sbs`
  - counts: local×33, sbs×25, express×13, limited_stop×3
  - accepted counts: local×30, sbs×25, express×12, limited_stop×3
  - canonical counts: local×22, sbs×17, express×7, limited_stop×4, rush×2
- **borough_normalized** (67 all / 61 accepted / 92 canonical, 5 distinct, singletons 0/5, open): `bronx` | `brooklyn` | `manhattan` | `queens` | `staten_island`
  - counts: manhattan×27, brooklyn×17, bronx×12, queens×7, staten_island×4
  - accepted counts: manhattan×26, brooklyn×13, bronx×11, queens×7, staten_island×4
  - canonical counts: manhattan×30, bronx×20, brooklyn×19, queens×17, staten_island×6
...
- **boroughs** (9 all / 8 accepted / 8 canonical, 3 distinct, singletons 0/3, open): `Bronx` | `Manhattan` | `Queens`
  - counts: Bronx×8, Manhattan×8, Queens×2
  - accepted counts: Bronx×7, Manhattan×7, Queens×2
  - canonical counts: Bronx×7, Manhattan×7, Queens×2
- **boroughs_normalized** (9 all / 8 accepted / 8 canonical, 3 distinct, singletons 0/3, open): `bronx` | `manhattan` | `queens`
  - counts: bronx×8, manhattan×8, queens×2
  - accepted counts: bronx×7, manhattan×7, queens×2
  - canonical counts: bronx×7, manhattan×7, queens×2
...
- (label ×4) M15
- (label ×3) M7
- (label ×3) Proposed B44 Local - Nostrand/Rogers Avenues
- (label ×2) B11
- (label ×2) B25
- (label ×2) B26
- (label ×2) B42
...
- (label ×2) Bx9
- (label ×2) BxM1 Express Bus
- (label ×2) M101
- (label ×2) M116
- (label ×2) Proposed B44 SBS - Nostrand Avenue
- (label ×2) Proposed B46 SBS - Utica Avenue
- (label ×2) Proposed B82 SBS - Southern Brooklyn
- (label ×2) Q43
- (label ×2) Q5
- (label ×2) Q54
- (label ×2) Q58
- (raw_text ×2) Blue hexagons represent M16/M34 stations
- (raw_text ×2) First implemented on Bx12 route – 20% travel time savings
...
submissions: 275 (accepted 271 / rejected 4); canonical records: 108

### Fields

| field | anchor | all | acc | canon | coverage | value_kind | distinct | classification | samples |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| entity_name | yes | 268 | 264 | 108 | 0.97 | scalar_string | 139 | free_text | New York City Department of Transportation, MTA New York City Transit… |
| entity_type | yes | 257 | 253 | 104 | 0.93 | scalar_string | 81 | free_text | government_agency, transit_agency, person, government agency, agency,… |
| agency_name | yes | 99 | 96 | 21 | 0.36 | scalar_string | 25 | free_text | NYC DOT, MTA, Metropolitan Transportation Authority, MTA New York Cit… |
| description | — | 70 | 69 | 47 | 0.25 | scalar_string | 67 | free_text | Partner agency in the LaGuardia Airport Access Alternatives Analysis,… |
| short_name | — | 27 | 27 | 9 | 0.10 | scalar_string | 12 | enum_candidate | NYC DOT, MTA, NYPD, MTA NYCT, NYCT, DDC, FTA, IBO |
| acronym | — | 23 | 23 | 9 | 0.08 | scalar_string | 11 | enum_candidate | MTA, NYCT, DOT, NYC DOT, NYPD, AAA, DOF, MTA Bus |
| role | — | 23 | 21 | 9 | 0.08 | scalar_string | 20 | free_text | ACE program partner, partner_agency, publisher, ACE program administr… |
| title | — | 17 | 17 | 16 | 0.06 | scalar_string | 16 | free_text | Project Manager, Acting Chief, Operations Planning, Chief Customer Of… |
| name | yes | 12 | 12 | 11 | 0.04 | scalar_string | 12 | free_text | CDC Social Vulnerability Index, data.ny.gov, Demetrius Crichlow, Kath… |
| publisher | yes | 12 | 11 | 4 | 0.04 | mixed | 3 | enum_candidate | NYC DOT, NYC Comptroller, People Oriented Cities |
| organization | — | 7 | 7 | 7 | 0.03 | scalar_string | 6 | free_text | Metropolitan Transportation Authority, New York State Assembly, New Y… |
| borough | — | 6 | 6 | 6 | 0.02 | scalar_string | 3 | enum_candidate | Manhattan, Brooklyn, Queens |
| operator | yes | 5 | 5 | 3 | 0.02 | mixed | 1 | free_text | MTA New York City Transit |
| jurisdiction | — | 4 | 4 | 4 | 0.01 | scalar_string | 1 | enum_candidate | New York State |
| borough_normalized | — | 3 | 3 | 6 | 0.01 | scalar_string | 1 | enum_candidate | manhattan |
...
| _merged_field_values | — | 0 | 0 | 28 | 0.00 | empty | 0 | sparse |  |

### Enum candidates (proposed closures, derived from corpus)

- **short_name** (27 all / 27 accepted / 9 canonical, 12 distinct, singletons 7/12, open): `DDC` | `FTA` | `IBO` | `MTA` | `MTA New York City Transit` | `MTA NYCT` | `MTABC` | `NYC DOT` | `NYCT` | `NYPD` | `NYSDOT` | `PANYNJ`
  - counts: NYC DOT×9, MTA×4, NYPD×3, MTA NYCT×2, NYCT×2
  - accepted counts: NYC DOT×9, MTA×4, NYPD×3, MTA NYCT×2, NYCT×2
- **acronym** (23 all / 23 accepted / 9 canonical, 11 distinct, singletons 6/11, open): `AAA` | `DOF` | `DOT` | `MTA` | `MTA Bus` | `MTA NYCT` | `NYC DOT` | `NYCT` | `NYPD` | `NYS ITS` | `PANYNJ`
  - counts: MTA×6, NYCT×4, DOT×3, NYC DOT×2, NYPD×2
  - accepted counts: MTA×6, NYCT×4, DOT×3, NYC DOT×2, NYPD×2
  - canonical counts: MTA×2
- **publisher** (12 all / 11 accepted / 4 canonical, 3 distinct, singletons 2/3, open): `NYC Comptroller` | `NYC DOT` | `People Oriented Cities`
  - counts: NYC DOT×4
  - accepted counts: NYC DOT×3
- **borough** (6 all / 6 accepted / 6 canonical, 3 distinct, singletons 2/3, open): `Brooklyn` | `Manhattan` | `Queens`
  - counts: Manhattan×4
  - accepted counts: Manhattan×4
  - canonical counts: Manhattan×4
...
- **borough_normalized** (3 all / 3 accepted / 6 canonical, 1 distinct, singletons 0/1, open): `manhattan`
  - counts: manhattan×3
  - accepted counts: manhattan×3
  - canonical counts: manhattan×4
...
- (label ×6) MTA New York City Transit
- (label ×4) MTA
- (label ×4) MTA Data & Analytics Team
- (label ×4) New York City Department of Transportation (NYC DOT)
- (label ×4) NYC Department of Transportation
- (label ×3) MTA Bus Company
- (label ×3) New York City Police Department (NYPD)
- (label ×3) NYC DOT
- (label ×2) ACE Program
- (label ×2) Demetrius Crichlow, President of New York City Transit
- (label ×2) Governor Kathy Hochul
- (label ×2) Manhattan Community Board 5
...
- (label ×2) Tri-State Transportation Campaign
- (raw_text ×4) MTA
- (raw_text ×4) NEW YORK CITY DOT
- (raw_text ×3) New York City Transit
...
submissions: 270 (accepted 260 / rejected 10); canonical records: 258

### Fields

| field | anchor | all | acc | canon | coverage | value_kind | distinct | classification | samples |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| description | yes | 270 | 260 | 258 | 1.00 | scalar_string | 251 | free_text | Developed / Published Plan, Busway launched October 2021, Capital imp… |
| event_kind | yes | 270 | 260 | 258 | 1.00 | scalar_string | 120 | free_text | service_launch, publication, launch, milestone, implementation, commu… |
| date_text | yes | 250 | 242 | 240 | 0.93 | scalar_string | 185 | free_text | 2024, 2023, 2019, October 2019, October 3, 2019, 2021, 2025, August 2… |
| date_text_normalized | — | 250 | 242 | 240 | 0.93 | object | 0 | structured |  |
| event_family | — | 63 | 60 | 258 | 0.23 | scalar_string | 12 | enum_candidate | public_engagement, other, launch, milestone, publication, implementat… |
| date | yes | 30 | 30 | 30 | 0.11 | scalar_string | 27 | free_text | 2019-10-03, 2023, 2008-01-01, 2011-03-25, 2011-05-12, 2011-06-14, 201… |
| date_normalized | — | 30 | 30 | 221 | 0.11 | object | 0 | structured |  |
| event_date | yes | 28 | 28 | 28 | 0.10 | scalar_string | 26 | free_text | December 2025, December 8, 2025, 2011-06-22, 2013-11-17, 2013-11-18,… |
| event_date_normalized | — | 28 | 28 | 28 | 0.10 | object | 0 | structured |  |
| year | — | 23 | 22 | 22 | 0.09 | number | 0 | numeric |  |
| event_name | — | 14 | 13 | 13 | 0.05 | scalar_string | 13 | free_text | Budget Press Tour, 168th St/Jamaica Interim Bus Terminal Opens, Bx6 L… |
...
| date_precision | — | 0 | 0 | 221 | 0.00 | empty | 0 | sparse |  |
| lifecycle_phase | — | 0 | 0 | 258 | 0.00 | empty | 0 | sparse |  |
| lifecycle_phase_other | — | 0 | 0 | 166 | 0.00 | empty | 0 | sparse |  |

### Enum candidates (proposed closures, derived from corpus)

- **event_family** (63 all / 60 accepted / 258 canonical, 12 distinct, singletons 6/12, open): `construction` | `implementation` | `launch` | `milestone` | `other` | `pause` | `postponement` | `press_release` | `public_engagement` | `publication` | `subway_service_start` | `tolling_program_commencement`
  - counts: public_engagement×28, other×10, launch×6, milestone×6, publication×5, implementation×2
  - accepted counts: public_engagement×27, other×10, launch×5, milestone×5, publication×5, implementation×2
  - canonical counts: public_engagement×58, launch×52, milestone×30, implementation×29, other×25, publication×25, construction×8, data_release×8, enforcement×6, legislation×6, pause×5, approval×2
...
`_merged_field_values`, `affected_boroughs`, `affected_routes`, `affected_stations`, `date_normalized`, `date_precision`, `date_text_normalized`, `details`, `end_date_text`, `end_date_text_normalized`, `event_date_normalized`, `event_family`, `event_name`, `lifecycle_phase`, `lifecycle_phase_other`, `location`, `location_normalized`, `month`, `organizers`, `participants`, `riders_affected`, `route`, `start_date_text`, `start_date_text_normalized`, `stations_affected`, `year`

### Repeated labels / raw_text (source_labels candidates)

- (label ×2) 181st Street Busway launched
- (label ×2) 34th Street Busway Community Outreach
- (label ×2) Begin Service (Target)
- (label ×2) Brooklyn Bus Network Redesign Public Launch
- (label ×2) COVID-19 Pause of Bus Network Redesign
...
- (raw_text ×2) Construction from Winter 2012 to Spring 2012, then Begin Service
...
submissions: 222 (accepted 216 / rejected 6); canonical records: 216

### Fields

| field | anchor | all | acc | canon | coverage | value_kind | distinct | classification | samples |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| treatment_kind | yes | 222 | 216 | 216 | 1.00 | scalar_string | 125 | free_text | bus_lane, route_type, bus_priority, enforcement, pedestrian_safety, b… |
| description | yes | 220 | 214 | 214 | 0.99 | scalar_string | 217 | free_text | Adds 18,700+ ft2 of painted pedestrian space. Daylighting at 10 inter… |
| treatment_family | — | 73 | 71 | 216 | 0.33 | scalar_string | 13 | free_text | other, pedestrian_or_accessibility, bus_lane, bus_stop_or_boarding, s… |
| locations | yes | 55 | 55 | 55 | 0.25 | mixed | 59 | free_text | 14th Street between 9th Avenue and 3rd Avenue, Jamaica, Queens, 34th… |
| locations_normalized | — | 53 | 53 | 53 | 0.24 | object | 0 | structured |  |
| treatment_type | yes | 51 | 51 | 51 | 0.23 | scalar_string | 45 | free_text | Crosstown (SBS), Express, Limited, Local, new_bus_lane, Rush, angled… |
| component_kind | yes | 50 | 45 | 45 | 0.23 | scalar_string | 37 | free_text | driving_directions, turn_restriction, concrete pedestrian space, pain… |
| component_type | yes | 31 | 31 | 31 | 0.14 | scalar_string | 30 | free_text | double_bus_lane, access_rule, automated_enforcement, bike_lane, bus_p… |
| location_text | — | 30 | 30 | 30 | 0.14 | scalar_string | 29 | free_text | Along 14th Street, 116th St from Manhattan Av. to 5th Av., 116th St.… |
| normalized_location | — | 30 | 30 | 30 | 0.14 | object | 0 | structured |  |
| date_text | — | 11 | 11 | 11 | 0.05 | scalar_string | 11 | free_text | 6 AM – 8 PM / 7 days a week, by end of 2008, December 2021, end of 20… |
| date_text_normalized | — | 11 | 11 | 11 | 0.05 | object | 0 | structured |  |
| count | — | 5 | 5 | 5 | 0.02 | number | 0 | numeric |  |
...
| access_points | — | 1 | 1 | 1 | 0.00 | array_string | 2 | sparse | north, south |
| allowed_vehicles | — | 1 | 1 | 1 | 0.00 | array_string | 5 | sparse | Access-A-Ride vans, bicycles, buses, emergency vehicles, trucks with… |
| days | — | 1 | 1 | 1 | 0.00 | scalar_string | 1 | sparse | 7 days/week |
| end_date | — | 1 | 1 | 1 | 0.00 | scalar_string | 1 | sparse | 2024-08-31 |
| end_date_normalized | — | 1 | 1 | 1 | 0.00 | object | 0 | structured |  |
| enforcement_methods | — | 1 | 1 | 1 | 0.00 | array_string | 2 | sparse | automated cameras, traffic agents |
| left_turns | — | 1 | 1 | 1 | 0.00 | scalar_string | 1 | sparse | restricted except eastbound left at 153rd St |
| parking_loading | — | 1 | 1 | 1 | 0.00 | scalar_string | 1 | sparse | no parking nor loading eastbound between 150th St and 160th St |
| passenger_vehicles_allowed | — | 1 | 1 | 1 | 0.00 | boolean | 0 | boolean |  |
| restricted_to | — | 1 | 1 | 1 | 0.00 | array_string | 3 | sparse | bicycles, buses, trucks |
| restricted_vehicles | — | 1 | 1 | 1 | 0.00 | array_string | 2 | sparse | for-hire vehicles, passenger vehicles |
| start_date | — | 1 | 1 | 1 | 0.00 | scalar_string | 1 | sparse | 2023-09-24 |
| start_date_normalized | — | 1 | 1 | 1 | 0.00 | object | 0 | structured |  |
| trucks_allowed | — | 1 | 1 | 1 | 0.00 | boolean | 0 | boolean |  |
...
`access_points`, `allowed_vehicles`, `corridor`, `count`, `date_text`, `date_text_normalized`, `days`, `direction`, `end_date`, `end_date_normalized`, `enforcement_authority`, `enforcement_methods`, `features`, `hours`, `left_turns`, `limits`, `local_access`, `location_text`, `locations_normalized`, `normalized_location`, `parking_loading`, `passenger_vehicles_allowed`, `pickup_dropoff`, `restricted_to`, `restricted_vehicles`, `start_date`, `start_date_normalized`, `street`, `through_trips_allowed`, `time_of_day`, `treatment_family`, `trucks_allowed`

### Repeated labels / raw_text (source_labels candidates)

- (label ×2) 34th St Busway Signage and Markings
- (label ×2) Bus Queue Jump Signal
- (label ×2) Concrete Pedestrian Space
- (label ×2) Crosstown (SBS) Route Type
- (label ×2) Express Route Type
- (label ×2) Limited Route Type
- (label ×2) Local Route Type
- (label ×2) Painted Pedestrian Space and Daylighting
- (label ×2) Rush Route Type
- (raw_text ×2) Two-way Transitway for length of 34th Street aligned along curb

## project

submissions: 158 (accepted 149 / rejected 9); canonical records: 111

### Fields

| field | anchor | all | acc | canon | coverage | value_kind | distinct | classification | samples |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| project_name | yes | 158 | 149 | 111 | 1.00 | scalar_string | 120 | free_text | 34th Street Transitway, Queens Bus Network Redesign, 14th Street Tran… |
| description | yes | 151 | 142 | 108 | 0.96 | scalar_string | 144 | free_text | 34th Street Transitway project presented to Manhattan Community Board… |
| status | yes | 146 | 137 | 107 | 0.92 | scalar_string | 48 | free_text | proposed_2019, completed, proposed, active, study, ongoing, operation… |
| project_type | yes | 135 | 126 | 93 | 0.85 | scalar_string | 77 | free_text | busway, new_bus_lane, bus_network_redesign, bus network redesign, bus… |
| borough | — | 52 | 47 | 40 | 0.33 | scalar_string | 5 | enum_candidate | Manhattan, Brooklyn, Bronx, Queens, Staten Island |
| project_family | — | 44 | 38 | 93 | 0.28 | scalar_string | 21 | free_text | sbs_or_brt, bus_priority, other, planning_or_report, bus_network_rede… |
| document_time_status | — | 43 | 37 | 107 | 0.27 | scalar_string | 11 | enum_candidate | implemented, other, active, planned, program_context, study, stalled_… |
| borough_normalized | — | 33 | 28 | 40 | 0.21 | scalar_string | 5 | enum_candidate | manhattan, bronx, queens, brooklyn, staten_island |
| daily_ridership | — | 24 | 24 | 24 | 0.15 | number | 0 | numeric |  |
| name | yes | 24 | 24 | 24 | 0.15 | scalar_string | 24 | free_text | 14th St, Ave A to Ave D, 42nd St, 12th Ave to FDR Dr, 96th St, Rivers… |
| routes_served | — | 24 | 24 | 24 | 0.15 | array_string | 106 | free_text | B103, B83, BM2, BM3, BM4, Q20A, Q20B, Q44 SBS |
| corridor_length_miles | — | 21 | 21 | 21 | 0.13 | number | 0 | numeric |  |
| boroughs | — | 5 | 5 | 5 | 0.03 | array_string | 4 | enum_candidate | Queens, Manhattan, Brooklyn, Bronx |
...
| boroughs_normalized | — | 3 | 3 | 5 | 0.02 | array_string | 3 | enum_candidate | manhattan, queens, bronx |
...
| _merged_field_values | — | 0 | 0 | 17 | 0.00 | empty | 0 | sparse |  |

### Enum candidates (proposed closures, derived from corpus)

- **borough** (52 all / 47 accepted / 40 canonical, 5 distinct, singletons 0/5, **saturated → closure candidate**): `Bronx` | `Brooklyn` | `Manhattan` | `Queens` | `Staten Island`
  - counts: Manhattan×24, Brooklyn×10, Bronx×8, Queens×8, Staten Island×2
  - accepted counts: Manhattan×20, Brooklyn×10, Queens×8, Bronx×7, Staten Island×2
  - canonical counts: Manhattan×17, Brooklyn×8, Queens×7, Bronx×6, Staten Island×2
- **document_time_status** (43 all / 37 accepted / 107 canonical, 11 distinct, singletons 3/11, open): `active` | `announced` | `construction_began_june_2016_anticipated_completion_summer_2017` | `implemented` | `launched_july_2015_post_implementation_progress_reported` | `other` | `planned` | `program_context` | `retrospective` | `stalled_resuming` | `study`
  - counts: implemented×11, other×6, active×5, planned×5, program_context×4, study×4, stalled_resuming×3, announced×2
  - accepted counts: implemented×11, planned×5, active×4, program_context×4, other×3, stalled_resuming×3, study×3
  - canonical counts: planned×44, implemented×27, active×13, study×10, stalled_resuming×3, under_construction×3, approved×2, pilot×2
- **borough_normalized** (33 all / 28 accepted / 40 canonical, 5 distinct, singletons 1/5, open): `bronx` | `brooklyn` | `manhattan` | `queens` | `staten_island`
  - counts: manhattan×17, bronx×6, queens×5, brooklyn×4
  - accepted counts: manhattan×13, bronx×5, queens×5, brooklyn×4
  - canonical counts: manhattan×17, brooklyn×8, queens×7, bronx×6, staten_island×2
- **boroughs** (5 all / 5 accepted / 5 canonical, 4 distinct, singletons 1/4, open): `Bronx` | `Brooklyn` | `Manhattan` | `Queens`
  - counts: Queens×4, Manhattan×3, Brooklyn×2
  - accepted counts: Queens×4, Manhattan×3, Brooklyn×2
  - canonical counts: Queens×4, Manhattan×3, Brooklyn×2
...
- **boroughs_normalized** (3 all / 3 accepted / 5 canonical, 3 distinct, singletons 1/3, open): `bronx` | `manhattan` | `queens`
  - counts: manhattan×3, queens×2
  - accepted counts: manhattan×3, queens×2
  - canonical counts: queens×4, manhattan×3, brooklyn×2
...
- (label ×5) 34th Street Transitway (Selected BRT Alternative)
- (label ×3) Brooklyn Bus Network Redesign
...
- (raw_text ×3) The BRT Alternative (\"34th Street Transitway\") is the Selected Alternative
...
- (raw_text ×2) The BRT Alternative ("34th Street Transitway") is the Selected Alternative
...
submissions: 122 (accepted 114 / rejected 8); canonical records: 75

### Fields

| field | anchor | all | acc | canon | coverage | value_kind | distinct | classification | samples |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| corridor_name | yes | 122 | 114 | 75 | 1.00 | scalar_string | 88 | free_text | 34th Street, Tremont Avenue, 116th Street, 34th Street Busway, Jamaic… |
| borough | — | 92 | 84 | 61 | 0.75 | scalar_string | 6 | enum_candidate | Manhattan, Brooklyn, Queens, Bronx, Staten Island, the Bronx |
| description | yes | 83 | 77 | 61 | 0.68 | scalar_string | 64 | free_text | Top-ranked NYC DOT Brooklyn bus priority corridor identified for pote… |
| street | yes | 68 | 61 | 38 | 0.56 | scalar_string | 39 | free_text | 34th Street, 14th Street, Tremont Avenue, Jamaica Avenue, Archer Aven… |
| limits | yes | 61 | 57 | 37 | 0.50 | scalar_string | 53 | free_text | Morningside Avenue to Pleasant Avenue, 23rd Street to 59th Street, 34… |
| borough_normalized | — | 47 | 41 | 61 | 0.39 | scalar_string | 5 | enum_candidate | brooklyn, manhattan, bronx, queens, staten_island |
| from | yes | 18 | 17 | 14 | 0.15 | scalar_string | 16 | free_text | Amsterdam Avenue, Third Ave. / Southern Blvd., 3rd Avenue, 9th Avenue… |
| to | yes | 18 | 17 | 14 | 0.15 | scalar_string | 15 | free_text | Broadway, Southern Blvd. / Belmont Ave., Southern Boulevard, 3rd Aven… |
| status | — | 12 | 12 | 11 | 0.10 | scalar_string | 4 | enum_candidate | Completed 2020, Future Plan, Planned, Present Implementation |
| routes | — | 11 | 11 | 11 | 0.09 | array_string | 33 | free_text | Bx36, Bx3, Bx35, Bx11, Bx12, Bx12 SBS, Bx13, Bx17 |
| corridor_length_mi | — | 10 | 10 | 10 | 0.08 | number | 0 | numeric |  |
| routes_served | — | 10 | 10 | 10 | 0.08 | array_string | 26 | free_text | Bx35, Bx36, Bx11, Bx12, Bx12 SBS, Bx13, Bx17, Bx18 |
| streets | yes | 10 | 10 | 10 | 0.08 | array_string | 64 | free_text | 1st Avenue, 3rd Avenue, 86th Street, Broadway, Fordham Road, 116th St… |
| combined_daily_ridership | — | 9 | 9 | 9 | 0.07 | number | 0 | numeric |  |
| days | — | 9 | 9 | 9 | 0.07 | scalar_string | 2 | enum_candidate | seven days a week, Monday through Friday |
| hours | — | 9 | 9 | 9 | 0.07 | scalar_string | 5 | enum_candidate | 6am to 8pm, 24 hours a day, 6am to 10pm, 6am to 7pm, 7am to 7pm |
| local_access | — | 9 | 9 | 8 | 0.07 | scalar_string | 8 | free_text | may turn onto the busway from a side street but must turn at next ava… |
| through_access_vehicles | — | 9 | 9 | 9 | 0.07 | array_string | 6 | enum_candidate | buses, emergency vehicles, trucks, Access-A-Ride vans, bicycles, buse… |
| boroughs | — | 3 | 3 | 3 | 0.02 | array_string | 4 | enum_candidate | Manhattan, Queens, Brooklyn, Bronx |
| bus_routes | — | 3 | 2 | 2 | 0.02 | number | 0 | numeric |  |
| daily_ridership_hours | — | 3 | 2 | 2 | 0.02 | scalar_string | 2 | enum_candidate | All Days, 6AM-8PM, All Days, 24/7 |
| direction | — | 3 | 3 | 3 | 0.02 | scalar_string | 2 | enum_candidate | both directions, eastbound only |
| ridership | — | 3 | 2 | 2 | 0.02 | number | 0 | numeric |  |
| ridership_text | — | 3 | 2 | 2 | 0.02 | scalar_string | 2 | enum_candidate | 139,000 daily riders, 189,000 daily riders |
| routes_note | — | 3 | 2 | 2 | 0.02 | scalar_string | 1 | free_text | Routes running between Sutphin Blvd & 168 St only |
...
| _merged_field_values | — | 0 | 0 | 14 | 0.00 | empty | 0 | sparse |  |
| boroughs_normalized | — | 0 | 0 | 3 | 0.00 | empty | 0 | sparse |  |

### Enum candidates (proposed closures, derived from corpus)

- **borough** (92 all / 84 accepted / 61 canonical, 6 distinct, singletons 1/6, open): `Bronx` | `Brooklyn` | `Manhattan` | `Queens` | `Staten Island` | `the Bronx`
  - counts: Manhattan×32, Brooklyn×31, Queens×13, Bronx×12, Staten Island×3
  - accepted counts: Brooklyn×31, Manhattan×26, Queens×12, Bronx×11, Staten Island×3
  - canonical counts: Brooklyn×29, Manhattan×13, Bronx×8, Queens×8, Staten Island×3
- **borough_normalized** (47 all / 41 accepted / 61 canonical, 5 distinct, singletons 1/5, open): `bronx` | `brooklyn` | `manhattan` | `queens` | `staten_island`
  - counts: brooklyn×20, manhattan×18, bronx×6, queens×2
  - accepted counts: brooklyn×20, manhattan×13, bronx×5, queens×2
  - canonical counts: brooklyn×29, manhattan×13, bronx×8, queens×8, staten_island×3
...
- (label ×4) 34th Street Transitway Corridor
- (label ×3) 34th Street Corridor Manhattan
- (label ×2) 116th Street Study Area, Manhattan
...
- (raw_text ×2) Two-way Transitway for length of 34th Street
- (raw_text ×2) Two-way Transitway for length of 34th Street aligned along curb

## source

submissions: 59 (accepted 57 / rejected 2); canonical records: 56

### Fields

| field | anchor | all | acc | canon | coverage | value_kind | distinct | classification | samples |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| publisher | — | 58 | 56 | 55 | 0.98 | scalar_string | 20 | free_text | NYC DOT, MTA, MTA New York City Transit, NYC Department of Transporta… |
| title | — | 38 | 38 | 37 | 0.64 | scalar_string | 34 | free_text | 34th Street Transitway, M86 Select Bus Service Progress Report, Tremo… |
| description | — | 25 | 23 | 23 | 0.42 | scalar_string | 24 | free_text | Schema definition with column names, data types, descriptions, and ca… |
| content_type | — | 23 | 23 | 23 | 0.39 | scalar_string | 12 | enum_candidate | presentation, text/html, application/pdf, report, article, brochure,… |
| date_text | — | 17 | 17 | 17 | 0.29 | scalar_string | 16 | free_text | February 2025, 12/01/22, 2017, April 2019, April 21, 2008, Fall 2019,… |
| date_text_normalized | — | 17 | 17 | 17 | 0.29 | object | 0 | structured |  |
| source_id | — | 13 | 13 | 13 | 0.22 | scalar_string | 13 | free_text | 14th_street_busway, 161st_bx6_capital_project_2026, 181st_street_jun2… |
| source_type | — | 12 | 11 | 11 | 0.20 | scalar_string | 9 | free_text | webpage, data_dictionary, brochure, dataset_dictionary, evaluation_re… |
| document_type | — | 10 | 9 | 9 | 0.17 | scalar_string | 9 | free_text | bus_network_redesign_plan, addendum, annual update / open data plan,… |
| document_date | — | 8 | 8 | 8 | 0.14 | scalar_string | 7 | free_text | 2025, 2016-06, 2020-07, 2022-06-23, 2022-12-01, 2025-09, 2026-01-27 |
| document_date_normalized | — | 8 | 8 | 8 | 0.14 | object | 0 | structured |  |
| source_url | — | 8 | 8 | 8 | 0.14 | scalar_string | 8 | free_text | https://capitaldashboard.mta.info/, https://www.mta.info/document/173… |
| source_name | — | 7 | 6 | 6 | 0.12 | scalar_string | 6 | free_text | Queens Bus Network Redesign Proposed Final Plan, 14th Street Transit… |
| date | — | 6 | 6 | 6 | 0.10 | scalar_string | 5 | free_text | June 2025, 2022-04-18, 2026, December 2025, Winter 2020 |
| date_normalized | — | 6 | 6 | 6 | 0.10 | object | 0 | structured |  |
| publication_date | — | 6 | 6 | 6 | 0.10 | scalar_string | 6 | free_text | 2011-06-22, 2017-07-24, 2021-12-03, 2022-12-01, 2026-03-24, October 2… |
| publication_date_normalized | — | 6 | 6 | 6 | 0.10 | object | 0 | structured |  |
| source_title | — | 6 | 6 | 6 | 0.10 | scalar_string | 6 | free_text | 14th Street Transit & Truck Priority Pilot Project Quarterly Report W… |
| url | — | 6 | 6 | 6 | 0.10 | scalar_string | 6 | free_text | https://comptroller.nyc.gov, https://www.mta.info/open-data, https://… |
| year | — | 6 | 5 | 5 | 0.10 | number | 0 | numeric |  |
| retrieved_at | — | 4 | 4 | 4 | 0.07 | scalar_string | 1 | enum_candidate | 2026-05-25T22:21:55.189Z |
| document_kind | — | 3 | 3 | 3 | 0.05 | scalar_string | 3 | enum_candidate | equity_evaluation, final_plan, monitoring_report |
| document_title | — | 3 | 3 | 3 | 0.05 | scalar_string | 3 | free_text | Bronx Bus Network Redesign Final Plan, METROPOLITAN TRANSPORTATION AU… |
| prepared_for | — | 3 | 3 | 3 | 0.05 | scalar_string | 3 | free_text | June 2025 meeting of the New York City Transit & Bus Committee, NYCDO… |
| dataset_name | — | 2 | 1 | 1 | 0.03 | scalar_string | 1 | enum_candidate | Bus Lanes |
| format | — | 2 | 1 | 1 | 0.03 | scalar_string | 1 | free_text | JSON data dictionary (Socrata API column metadata) |
| program | — | 2 | 2 | 2 | 0.03 | scalar_string | 2 | enum_candidate | Better Buses Restart, BETTERBUSES |
| record_count | — | 2 | 1 | 1 | 0.03 | number | 0 | numeric |  |
| report_type | — | 2 | 2 | 2 | 0.03 | scalar_string | 2 | enum_candidate | performance evaluation, preliminary report |
| source_kind | — | 2 | 2 | 2 | 0.03 | scalar_string | 2 | enum_candidate | brochure, webpage |
| total_blocks | — | 2 | 2 | 2 | 0.03 | number | 0 | numeric |  |
| total_pages | — | 2 | 2 | 2 | 0.03 | number | 0 | numeric |  |
...
| _merged_field_values | — | 0 | 0 | 1 | 0.00 | empty | 0 | sparse |  |
| authority_tier | — | 0 | 0 | 45 | 0.00 | empty | 0 | sparse |  |
| published_date_normalized | — | 0 | 0 | 49 | 0.00 | empty | 0 | sparse |  |
| published_date_precision | — | 0 | 0 | 49 | 0.00 | empty | 0 | sparse |  |
| published_date_provenance | — | 0 | 0 | 13 | 0.00 | empty | 0 | sparse |  |

### Enum candidates (proposed closures, derived from corpus)

- **content_type** (23 all / 23 accepted / 23 canonical, 12 distinct, singletons 8/12, open): `application/pdf` | `article` | `brochure` | `draft_plan` | `html` | `presentation` | `presentation_slides` | `press release` | `Press Release` | `progress report` | `report` | `text/html`
  - counts: presentation×5, text/html×4, application/pdf×3, report×3
  - accepted counts: presentation×5, text/html×4, application/pdf×3, report×3
  - canonical counts: presentation×5, text/html×4, application/pdf×3, report×3
...
`_merged_field_values`, `author`, `authority_tier`, `commissioner`, `content_type`, `coverage_period`, `dataset_name`, `date`, `date_normalized`, `date_prepared`, `date_text`, `date_text_normalized`, `description`, `document_date`, `document_date_normalized`, `document_kind`, `document_title`, `document_type`, `event`, `format`, `language`, `location`, `location_normalized`, `prepared_for`, `program`, `project`, `publication_date`, `publication_date_normalized`, `publication_date_text`, `publication_date_text_normalized`, `publication_name`, `published_date_normalized`, `published_date_precision`, `published_date_provenance`, `publisher`, `record_count`, `report_type`, `retrieved_at`, `series`, `source_date`, `source_date_normalized`, `source_group`, `source_id`, `source_kind`, `source_label`, `source_name`, `source_title`, `source_type`, `source_url`, `status`, `title`, `total_blocks`, `total_pages`, `url`, `year`

### Repeated labels / raw_text (source_labels candidates)

- (label ×2) 34th Street Transitway - Manhattan Community Board 5 Presentation
