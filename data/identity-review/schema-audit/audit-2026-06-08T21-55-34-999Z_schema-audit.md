...
run_id: 2026-06-08T21-55-34-999Z_schema-audit
generated_at: 2026-06-08T21:55:34.999Z
...
| fine_tier | — | 5 | 0.01 | scalar_string | 5 | enum_candidate | fifth and subsequent offenses, first offense, fourth offense, second… |
...
- **fine_tier** (5 occ, 5 distinct): `fifth and subsequent offenses` | `first offense` | `fourth offense` | `second offense` | `third offense`
...
| routes | — | 8 | 0.02 | array_string | 12 | enum_candidate | Bx40, Bx42, Bx36, B44 SBS, Bx15, Bx28, Bx38, Bx5 |
...
| location | — | 6 | 0.02 | scalar_string | 5 | enum_candidate | Throgs Neck, Grand Concourse, Norwood, Story Avenue, Tremont Avenue /… |
...
| features | — | 2 | 0.01 | array_string | 7 | enum_candidate | off-board fare payment, dedicated bus lanes, limited stops, low-floor… |
...
- **routes** (8 occ, 12 distinct): `B44 SBS` | `Bx15` | `Bx28` | `Bx36` | `Bx38` | `Bx40` | `Bx42` | `Bx5` | `Bx6 SBS` | `M125` | `M14 SBS` | `M15 SBS`
  - counts: Bx40×4, Bx42×4, Bx36×2
- **existing** (6 occ, 2 distinct): `15-or-better` | `30-or-better`
  - counts: 15-or-better×5
- **location** (6 occ, 5 distinct): `Grand Concourse` | `Norwood` | `Story Avenue` | `Throgs Neck` | `Tremont Avenue / East 180 Street / Webster Avenue`
  - counts: Throgs Neck×2
...
- **unit** (3 occ, 1 distinct): `feet`
  - counts: feet×3
- **features** (2 occ, 7 distinct): `dedicated bus lanes` | `limited stops` | `low-floor three-door articulated buses` | `MTA Bus Time displays` | `neighborhood maps` | `off-board fare payment` | `transit signal priority`
  - counts: off-board fare payment×2
...
| routes_affected | — | 2 | 0.01 | array_string | 5 | enum_candidate | Bx5, M100, M2, M4, M42 |
...
- **routes_affected** (2 occ, 5 distinct): `Bx5` | `M100` | `M2` | `M4` | `M42`
  - counts: Bx5×2, M100×2, M2×2, M4×2, M42×2
...
| related_existing_routes | — | 3 | 0.01 | array_string | 5 | enum_candidate | B1, B3, B44, B44 SBS, B49 |
...
- **related_existing_routes** (3 occ, 5 distinct): `B1` | `B3` | `B44` | `B44 SBS` | `B49`
...
| acronym | — | 12 | 0.06 | scalar_string | 9 | enum_candidate | MTA, NYCT, AAA, DOF, DOT, MTA Bus, NYPD, NYS ITS |
| name | yes | 12 | 0.06 | scalar_string | 12 | enum_candidate | CDC Social Vulnerability Index, data.ny.gov, Demetrius Crichlow, Kath… |
...
- **acronym** (12 occ, 9 distinct): `AAA` | `DOF` | `DOT` | `MTA` | `MTA Bus` | `NYCT` | `NYPD` | `NYS ITS` | `PANYNJ`
  - counts: MTA×3, NYCT×2
- **name** (12 occ, 12 distinct): `CDC Social Vulnerability Index` | `data.ny.gov` | `Demetrius Crichlow` | `Kathy Hochul` | `Lisa Mae Fiedler` | `MTA` | `MTA Bus Company` | `MTA New York City Transit` | `New York City Department of Transportation` | `New York State Legislature` | `NYC DOT` | `NYPD`
...
| table_name | yes | 6 | 0.04 | scalar_string | 6 | enum_candidate | Bus Lanes, eastbound_access, express_bus_route_improvements, regular_… |
...
- **table_name** (6 occ, 6 distinct): `Bus Lanes` | `eastbound_access` | `express_bus_route_improvements` | `regular_bus_route_improvements` | `weekday_frequency_categories` | `westbound_access`
...
| features | — | 2 | 0.01 | array_string | 8 | enum_candidate | dedicated bus lanes, left-turn lanes, limited stops, low-floor three-… |
...
- **features** (2 occ, 8 distinct): `dedicated bus lanes` | `left-turn lanes` | `limited stops` | `low-floor three-door articulated buses` | `new bus shelters` | `off-board fare payment` | `pedestrian refuge islands` | `transit signal priority`
...
| location | — | 5 | 0.05 | scalar_string | 5 | enum_candidate | 14th Street, Manhattan, Bronx, New York City, Church Avenue Station,… |
...
- **location** (5 occ, 5 distinct): `14th Street, Manhattan` | `Bronx, New York City` | `Church Avenue Station, Brooklyn` | `Queens` | `Sunset Park, Brooklyn`
...
| source_type | — | 12 | 0.29 | scalar_string | 9 | enum_candidate | webpage, data_dictionary, brochure, dataset_dictionary, evaluation_re… |
| document_type | — | 10 | 0.24 | scalar_string | 9 | enum_candidate | bus_network_redesign_plan, addendum, annual update / open data plan,… |
| document_date | — | 8 | 0.19 | scalar_string | 7 | enum_candidate | 2025, 2016-06, 2020-07, 2022-06-23, 2022-12-01, 2025-09, 2026-01-27 |
...
| url | — | 6 | 0.14 | scalar_string | 6 | enum_candidate | https://comptroller.nyc.gov, https://www.mta.info/open-data, https://… |
...
- **source_type** (12 occ, 9 distinct): `brochure` | `data_dictionary` | `dataset_dictionary` | `evaluation_report` | `monitoring_report` | `plan` | `press_release` | `report` | `webpage`
  - counts: webpage×3, data_dictionary×2
- **document_type** (10 occ, 9 distinct): `addendum` | `annual update / open data plan` | `annual_report` | `bus_network_redesign_plan` | `draft_plan` | `monitoring_update` | `performance_report` | `plan` | `progress_report`
  - counts: bus_network_redesign_plan×2
- **document_date** (8 occ, 7 distinct): `2016-06` | `2020-07` | `2022-06-23` | `2022-12-01` | `2025` | `2025-09` | `2026-01-27`
  - counts: 2025×2
- **content_type** (6 occ, 3 distinct): `application/pdf` | `html` | `text/html`
  - counts: text/html×3, application/pdf×2
- **url** (6 occ, 6 distinct): `https://comptroller.nyc.gov` | `https://www.mta.info/open-data` | `https://www.nyc.gov` | `nyc.gov/34Busway` | `nyc.gov/betterbuses` | `nyc.gov/busprojects`
