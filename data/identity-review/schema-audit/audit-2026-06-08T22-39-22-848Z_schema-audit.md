...
- **time_period** (31 occ, 9 distinct, singletons 1/9, open): `AM Peak (6-10 AM)` | `Daily` | `Dec-July (2021-2022)` | `Dec-July average (2017-2018, 2018-2019, 2019-2020, 2020-2021)` | `Midday (10AM-3PM)` | `PM peak` | `PM Peak (3-7 PM)` | `Sep 2022 – May 2023` | `Sep 2023 – May 2024`
...
- **borough** (78 occ, 5 distinct, singletons 0/5, **saturated → closure candidate**): `Bronx` | `Brooklyn` | `Manhattan` | `Queens` | `Staten Island`
