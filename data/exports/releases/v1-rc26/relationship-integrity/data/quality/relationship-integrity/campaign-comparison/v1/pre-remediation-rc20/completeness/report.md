...
Schema version: 1. Mode: **warning**. Release: **v1-rc20**.
...
- All enforcement-candidate contract-role failures: 1 occurrence(s).
- Phase/schema migration warnings: 134 occurrence(s).
- Physical scope required: 1; not applicable: 133; physicality review required: 0.
- Eligible event identities inside the implementation/launch denominator: 131; outside: 3.
...
- Immutable ledger complete: true; physical scope complete: false; final release guard: pending.

## Full bus-lane treatment physical-scope denominator

- Immutable inventory rows: 663; audited selector rows: 663; omitted: 0.
- Canonically materialized treatments: 662; accepted pending addition: 1.
- Canonical physical scope satisfied: 156; evidence-bound reviewed non-projectable dispositions: 507.
- Exact evidence bound: 663; warning rows: 0; review complete: true.

## Full operational-event denominator

- Operational-family events: 1362.
- Primary dispositions: eligible occurrence present 131; legacy terminal gaps only 0; open review 0; versioned non-projectable 1231.
- Gap rows: 2934; events with an unreviewed gap: 1145.
- Eligible occurrence/coverage conflicts: 0.

## Canonical route-identity denominator

- Canonical routes: 376; audited exactly once: 376.
- GTFS-backed route records: 281; reviewed typed non-projectable 95.
...
| `RC_OCCURRENCE_PHASE_IDENTITY_MISSING` | schema_migration | 134 |
| `RC_OCCURRENCE_PHASE_RELATION_MISSING` | schema_migration | 134 |
| `RC_OCCURRENCE_PHYSICALITY_REVIEW_REQUIRED` | enforcement_candidate | 0 |
| `RC_OCCURRENCE_PHYSICAL_SCOPE_MISSING` | enforcement_candidate | 1 |
...
- Phase contract ready: false.
- Physical-scope contract ready: false.
- Treatment physicality contract ready: true.
- Treatment physicality final-release guard ready: false.
