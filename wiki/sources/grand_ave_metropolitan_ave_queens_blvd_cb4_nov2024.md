...
record_id: "source_grand-ave-metropolitan-ave-queens-blvd-cb4-nov2024"
record_kind: "source"
display_name: "Grand St/Grand Av Safety & Bus Priority Improvements - Queens CB4 Nov 2024"
source_id: "grand_ave_metropolitan_ave_queens_blvd_cb4_nov2024"
source_ids:
  - "grand_ave_metropolitan_ave_queens_blvd_cb4_nov2024"
local_observation_id: "source_grand_ave_cb4_nov2024"
local_observation_ids:
  - "source_grand_ave_cb4_nov2024"
review_state: "unreviewed"
truth_status: "source_stated"
generated_at: "2026-06-19T18:42:19.394Z"
submission_ids:
  - "sub_6e4e97d32e155fea"
payload:
  authority_tier: "board_material"
  content_type: "presentation"
  date_text: "November 26, 2024"
  date_text_normalized:
    confidence: "parsed_text"
    normalized_date: "2024-11-26"
    precision: "day"
    raw_text: "November 26, 2024"
  description: "Presentation to Queens Community Board 4 Transportation Committee about Grand Street/Grand Avenue safety and bus priority improvements from Metropolitan Avenue to Queens Boulevard"
  published_date_normalized: "2024-11-26"
...
evidence_refs:
  -
    block_id: "p001_c0001"
    evidence_id: "grand_ave_metropolitan_ave_queens_blvd_cb4_nov2024#p001_c0001"
    page_number: 1
    role: "title"
    source_id: "grand_ave_metropolitan_ave_queens_blvd_cb4_nov2024"
  ...
  -
    block_id: "p001_c0002"
    evidence_id: "grand_ave_metropolitan_ave_queens_blvd_cb4_nov2024#p001_c0002"
    page_number: 1
    role: "audience"
    source_id: "grand_ave_metropolitan_ave_queens_blvd_cb4_nov2024"
    source_path: "raw/sources/grand_ave_metropolitan_ave_queens_blvd_cb4_nov2024/blocks.jsonl"
    text_sha256: "sha256:68cfbb0ef1eaef7421ffb19ed774614a2db1c944bddf5b540982918dc56b972e"
    text_source: "raw_text"
  -
    block_id: "p001_c0003"
    evidence_id: "grand_ave_metropolitan_ave_queens_blvd_cb4_nov2024#p001_c0003"
    page_number: 1
    role: "date"
    source_id: "grand_ave_metropolitan_ave_queens_blvd_cb4_nov2024"
    source_path: "raw/sources/grand_ave_metropolitan_ave_queens_blvd_cb4_nov2024/blocks.jsonl"
    text_sha256: "sha256:86a79318f63934193525f3a0041402ccb8b44969f4e6e3a269bcd0ca8d4cfb99"
    text_source: "raw_text"
---

# Grand Street/Grand Avenue, Metropolitan Avenue to Queens Boulevard - presented to Queens Community Board 4 in November 2024 (pdf)
...
[p001_c0002] Queens Community Board 4 Transportation Committee
[p001_c0003] November 26, 2024
...
> [p007_c0002] A photograph showing a long line of buses and trucks on Grand Avenue, illustrating traffic congestion. A bus in the foreground has 'NOT IN' on its destination sign. A 'NO PARKING ANY TIME' sign is visible on a utility pole.
...
[p007_c0006] _7_
[p007_c0007] _The MTA logo, consisting of the letters 'MTA' in a bold, sans-serif font inside a dark circle._
[p007_c0008] _The BETTERBUSES logo, with 'BETTER' in blue and 'BUSES' in green, separated by a stylized blue and green graphic._
[p007_c0009] _The New York City Department of Transportation (NYC DOT) logo, featuring the words 'NEW YORK CITY' above 'DOT' and a stylized graphic of a bridge or road._
...
> [p008_c0003] AM Peak Bus Speeds This map displays bus speed data during the AM Peak. The route is shown as a colored line along Grand Ave and St L. The legend indicates four speed ranges: <6 MPH (dark red), 6-8 MPH (orange), 8-10 MPH (yellow), and >10 MPH (light yellow). The route shows significant slowdowns (dark red) near Grand St L and the Long Island Expressway (I-495), and speeds exceeding 10 MPH (light yellow) in some sections. Legend <6 MPH 6-8 MPH 8-10 MPH >10 MPH
> [p008_c0004] PM Peak Bus Speeds This map displays bus speed data during the PM Peak. The route is shown as a colored line along Grand Ave and St L. The legend indicates four speed ranges: <6 MPH (dark red), 6-8 MPH (orange), 8-10 MPH (yellow), and >10 MPH (light yellow). The route shows significant slowdowns (dark red) near Grand St L and the Long Island Expressway (I-495), and speeds exceeding 10 MPH (light yellow) in some sections. Legend <6 MPH 6-8 MPH 8-10 MPH >10 MPH
...
> [p013_c0003] A photograph of a city street intersection. In the foreground, a red flatbed truck is stopped at a crosswalk. Behind it, a white SUV is also stopped. Further back, a blue bus is visible. The street is lined with trees and buildings. Traffic lights are visible on poles. The sky is clear and blue.
[p013_c0004] _Grand St and Lorimer St_
> [p013_c0005] A photograph looking down the length of a green steel truss bridge. The bridge has a complex lattice of steel beams. A person is seen climbing on one of the upper truss members. The bridge spans over a body of water, and a white van is visible on the road further down the bridge. The sky is blue with some clouds.
[p013_c0006] _Grand St Bridge_
[p013_c0007] _13_
[p013_c0008] _The logo for the Metropolitan Transportation Authority (MTA), featuring the letters 'MTA' in a stylized font inside a circle._
[p013_c0009] _The logo for 'BETTERBUSES', with 'BETTER' in blue and 'BUSES' in green, accompanied by a stylized graphic of a bus._
[p013_c0010] _The logo for the New York City Department of Transportation (NYC DOT), featuring the words 'NEW YORK CITY' above 'DOT' in a stylized font._
...
> [p016_c0005] A photograph of a center bus lane on 161st St in Brooklyn. The lane is red-painted and separated from the adjacent traffic lane by a row of white plastic bollards. Several vehicles, including a white pickup truck and an ambulance, are visible in the lane. The street is lined with buildings and parked cars on the right side.
...
> [p016_c0011] A photograph of a bus in a curbside bus lane on Hylan Blvd in Illinois. The bus is a blue and white MTA bus, and it is stopped at a bus stop. The lane is red-painted and separated from the adjacent traffic lane by a white line. The street is lined with buildings and a sidewalk.
[p016_c0012] _Curbside Bus Lane_
[p016_c0013] Hylan Blvd, SI
> [p016_c0014] A photograph of a bus at a queue jump signal on Broadway in Queens. The bus is a blue and white MTA bus, and it is stopped at a signal. The signal is a traffic light with a 'BUSES ONLY SIGNAL' sign. The street is lined with buildings and a sidewalk.
...
> [p018_c0002] A photograph showing a pedestrian island at a street intersection. The island is a raised concrete structure with a red-painted area. Pedestrians are walking across the island and the crosswalk. A cyclist is also visible on the left side of the road. The street is lined with parked cars and a bus. A traffic light is visible on the right side of the island.
[p018_c0003] _Pedestrian Island_
[p018_c0004] Fordham Rd, BK
> [p018_c0005] A photograph of a bus boarding island. A blue bus is stopped at the island. Several people are waiting on the sidewalk. A bus stop sign is visible, showing bus numbers 87, 882, and 882. The island is a raised concrete structure with a red-painted area. The street is lined with buildings and trees.
...
[p021_c0005] _The New York City Department of Transportation (NYC DOT) logo, featuring the text "NEW YORK CITY" above "DOT" and a stylized graphic of a bus and a train._
...
[p026_c0006] _The NEW YORK CITY DOT logo, with 'NEW YORK CITY' in small text above 'DOT' in large, bold letters, with a stylized graphic below._
