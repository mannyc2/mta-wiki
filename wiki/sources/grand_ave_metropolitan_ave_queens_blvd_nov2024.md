...
record_id: "source_grand-ave-metropolitan-ave-queens-blvd-nov2024"
record_kind: "source"
display_name: "Grand St/Grand Av Safety & Bus Priority Improvements - Brooklyn Community Board 1"
source_id: "grand_ave_metropolitan_ave_queens_blvd_nov2024"
source_ids:
  - "grand_ave_metropolitan_ave_queens_blvd_nov2024"
local_observation_id: "source_grand_ave_metropolitan_ave_queens_blvd_nov2024"
local_observation_ids:
  - "source_grand_ave_metropolitan_ave_queens_blvd_nov2024"
review_state: "unreviewed"
truth_status: "source_stated"
generated_at: "2026-06-19T18:40:57.211Z"
raw_text: "Grand St/Grand Av Safety & Bus Priority Improvements presentation to Brooklyn Community Board 1, November 12, 2024"
submission_ids:
  - "sub_e29e56eae2eb8345"
payload:
  ...
  date_normalized:
    ...
    precision: "day"
    raw_text: "November 12, 2024"
  prepared_for: "Brooklyn Community Board 1"
  published_date_normalized: "2024-11-12"
...
evidence_refs:
  -
    block_id: "p001_c0001"
    evidence_id: "grand_ave_metropolitan_ave_queens_blvd_nov2024#p001_c0001"
    page_number: 1
    role: "title"
    source_id: "grand_ave_metropolitan_ave_queens_blvd_nov2024"
  ...
  -
    block_id: "p001_c0002"
    evidence_id: "grand_ave_metropolitan_ave_queens_blvd_nov2024#p001_c0002"
    page_number: 1
    role: "audience"
    source_id: "grand_ave_metropolitan_ave_queens_blvd_nov2024"
    source_path: "raw/sources/grand_ave_metropolitan_ave_queens_blvd_nov2024/blocks.jsonl"
    text_sha256: "sha256:21628ff8fc739a51b3424ff66e42a97bd9bafe6e248d3f3427d3fb77ca9971b7"
    text_source: "raw_text"
  -
    block_id: "p001_c0003"
    evidence_id: "grand_ave_metropolitan_ave_queens_blvd_nov2024#p001_c0003"
    page_number: 1
    role: "date"
    source_id: "grand_ave_metropolitan_ave_queens_blvd_nov2024"
    source_path: "raw/sources/grand_ave_metropolitan_ave_queens_blvd_nov2024/blocks.jsonl"
    text_sha256: "sha256:cd5ad6734c8eb0c57752c9422f477e7afa315ab8d3f9cc7d107089b062e17d71"
    text_source: "raw_text"
---

# Grand Street/Grand Avenue, Metropolitan Avenue to Queens Boulevard - presented to Brooklyn Community Board 1 in November 2024 (pdf)
...
[p001_c0002] Brooklyn Community Board 1
[p001_c0003] November 12, 2024
> [p001_c0004] A photograph of a busy street intersection in Brooklyn, New York, under a cloudy sky. A large blue semi-truck with a white trailer is on the right, and several cars are in the left lane. A white MTA bus is visible in the distance. Traffic lights are visible, and street signs for 'PETH CITY' and 'NORTH AVENUE' are present. A tall utility pole stands on the right side of the street.
> [p001_c0005] The MTA logo, consisting of the letters 'MTA' in a bold, sans-serif font inside a dark circle.
[p001_c0006] BETTERBUSES
> [p001_c0007] The New York City Department of Transportation (NYC DOT) logo, featuring the words 'NEW YORK CITY' above a stylized 'DOT' with three horizontal bars.
...
[p005_c0006] _Source: NYC Streets Plan_
[p005_c0007] _3_
[p005_c0008] _5_
...
[p007_c0002] _Traffic congestion looking east on Grand Avenue from 47 th St_
[p007_c0003] Source: [MTA]
- [p007_c0004] • Operates 10 bus routes, including the B38, B47, B57, B60, B62, and Q59 • 1,032 buses pulling in and out of the depot every weekday , including over 80 movements during the busiest hour • Significant operational difficulties for pull-in and pull-out due to truck traffic and congestion from Grand St Bridge, resulting in longer wait times and less reliable service for riders • Improvements along Grand Avenue that prioritize bus service and depot access will result in more reliable, faster buses in an area lacking direct subway service
[p007_c0005] _7_
...
```text
Grand St/Grand Av, 2019-2023 (5 years) Total Injuries Severe Injuries Fatalities KSI Pedestrian 73 8 2 10 Bicyclists 77 5 0 5 Motor Vehicle Occupant 189 10 1 11 Other Motorized 20 2 0 2 Total 359 25 4 28
```
...
> [p012_c0004] A diagram illustrating a street layout with bike lanes, specifically for 74th St – Qns Blvd. The total width is 50 feet. The layout includes a 'North Sidewalk' and a 'South Sidewalk'. The street is divided into six lanes: 9' Parking Lane, 5' Bike Lane, 11' Travel Lane, 11' Travel Lane, 5' Bike Lane, and 9' Parking Lane. The street contains a white truck, a grey truck, a grey bus, a white car, and two people on bicycles. A box in the top right corner is labeled '74th St – Qns Blvd'.
[p012_c0005] _12_
...
> [p016_c0002] A photograph showing a New York City MTA bus in a dedicated, red-painted bus lane. The lane is offset from the curb, with a white line marking its edge. A dark-colored SUV is stopped in the adjacent lane. The bus is heading towards the viewer, and its destination sign reads '021 B' with 'B' in red and 'WEST 140TH ST' in white. The street is lined with trees and a sidewalk on the left.
[p016_c0003] _Offset Bus Lane_
[p016_c0004] Woodhaven Blvd, QN
> [p016_c0005] A photograph of a center bus lane on 161st St in Brooklyn. The lane is red-painted and separated from the adjacent traffic lane by a row of white plastic bollards. Several vehicles, including a white pickup truck and an ambulance, are visible in the lane. The street is lined with buildings and parked cars.
[p016_c0006] _Center Bus Lane/ Physical Protection_
[p016_c0007] 161st St, BX
> [p016_c0008] A photograph of a bus and a truck on 14th St in Minnesota. The bus is a blue and white MTA bus, and the truck is a blue United truck. They are on a multi-lane road with yellow double lines. The bus is in the leftmost lane, and the truck is in the middle lane. The street is lined with trees and buildings.
[p016_c0009] _Busway/Transit & Truck Priority_
[p016_c0010] 14th St, MN
> [p016_c0011] A photograph of a bus in a curbside bus lane on Hylan Blvd in Illinois. The bus is a blue and white MTA bus, and it is stopped at a bus stop. The lane is red-painted and separated from the adjacent traffic lane by a white line. The street is lined with buildings and trees.
[p016_c0012] _Curbside Bus Lane_
[p016_c0013] Hylan Blvd, SI
> [p016_c0014] A photograph of a bus at a queue jump signal on Broadway in Queens. The bus is a blue and white MTA bus, and it is stopped at a signal. The signal is a traffic light with a 'BUSES ONLY SIGNAL' sign. The street is lined with buildings and trees.
...
> [p018_c0002] A photograph showing a pedestrian island at a street intersection. The island is a raised concrete structure with a red-painted area. Pedestrians are walking across the island and the crosswalk. A cyclist is also visible on the left side of the road. The street is lined with cars and a bus. A traffic light is visible on the right side of the island.
[p018_c0003] _Pedestrian Island_
[p018_c0004] Fordham Rd, BK
> [p018_c0005] A photograph of a bus boarding island. A blue bus is stopped at the island. People are waiting on the sidewalk. A bus stop sign is visible, showing bus numbers 87, 882, and 882. The island is a raised concrete structure with a red-painted area. The street is lined with buildings and trees.
[p018_c0006] _Bus Boarding Island_
[p018_c0007] Kings Hwy, BK
> [p018_c0008] A photograph of a median extension at a street intersection. The median is a raised concrete structure with a red-painted area. Two people are walking on the median. The street is lined with buildings and trees. A traffic light is visible on the right side of the median.
[p018_c0009] _Median Extension_
[p018_c0010] 149 th St, BX
> [p018_c0011] A photograph of a painted curb extension at a street intersection. The curb extension is a raised concrete structure with a red-painted area. Pedestrians are walking on the curb extension and the crosswalk. The street is lined with buildings and trees. A traffic light is visible on the right side of the curb extension.
...
> [p019_c0005] A close-up photograph of a black parking meter. It features a blue sign with a white 'P' and the text 'Zone# 107011'. Below this is a 'Pay by Kid' button and a 'PARKNYC' logo. The meter is located on a sidewalk next to a tree with yellow leaves.
### [p019_c0006] Short-Term Parking
> [p019_c0007] A photograph of a parking sign mounted on a pole. The sign is divided into three sections: the top section shows a 'No Parking' symbol and 'Saturday Midnight - 3am' with a double-headed arrow; the middle section shows '1 hour metered parking' with '8am - 7pm Except Sunday' and a left-pointing arrow; the bottom section shows '15 minute parking' with a right-pointing arrow. The sign also includes 'Zone# 336789' and a 'P' symbol. The background shows a brick building.
### [p019_c0008] No Parking/ No Standing
> [p019_c0009] A photograph of a parking sign. The top section is red and says 'NO STANDING Anytime' with a right-pointing arrow. The middle section is white with a 'No Parking' symbol and says 'Monday - Frid 8am - 8:30am' with a left-pointing arrow. The bottom section is white and says '2 hour metered parking' with 'Monday - Friday 8:30am - 7pm' and a left-pointing arrow. The sign is mounted on a pole in front of a brick building.
[p019_c0010] _19_
[p019_c0011] _The MTA logo, consisting of the letters 'MTA' inside a circle._
[p019_c0012] _The logo for 'BETTERBUSES' in a stylized font._
[p019_c0013] _The logo for the New York City Department of Transportation (NYC DOT)._
...
> [p024_c0002] This diagram illustrates a 'Single Offset Lane' design for a 50-foot wide street. The street is flanked by a North Sidewalk and a South Sidewalk. The lane configuration from left to right is: an 8-foot Parking Lane, a 12-foot Offset Bus Lane (highlighted in red), an 11-foot Travel Lane, an 11-foot Travel Lane (separated by a yellow double line), and an 8-foot Parking Lane. Vehicles shown include a truck in the parking lane, a bus in the offset lane, a car in the first travel lane, a truck in the second travel lane, and a car in the third parking lane. A dimension line below the street indicates a total width of 50'. North Sidewalk 8' Parking Lane 12' Offset Bus Lane 11' Travel Lane 11' Travel Lane 8' Parking Lane South Sidewalk 50' Single Offset Lane
> [p024_c0003] This diagram illustrates a 'Single Curbside Lane' design for a 50-foot wide street. The street is flanked by a North Sidewalk and a South Sidewalk. The lane configuration from left to right is: a 14-foot Curbside Bus Lane (highlighted in red), an 11-foot Travel Lane, an 11-foot Travel Lane (separated by a yellow double line), and a 9-foot Parking Lane. Vehicles shown include a bus in the curbside lane, a car in the first travel lane, a truck in the second travel lane, and a car in the third parking lane. A dimension line below the street indicates a total width of 50'. North Sidewalk 14' Curbside Bus Lane 11' Travel Lane 11' Travel Lane 9' Parking Lane South Sidewalk 50' Single Curbside Lane
[p024_c0004] _24_
...
> [p027_c0004] The Facebook "f" logo in white.
[p027_c0005] NYC DOT
> [p027_c0006] The Twitter bird logo in white.
[p027_c0007] NYC DOT
> [p027_c0008] The Instagram camera logo in white.
[p027_c0009] nyc_dot
> [p027_c0010] The YouTube logo in white, featuring the word "You" above "Tube".
[p027_c0011] NYC DOT
[p027_c0012] _27_
[p027_c0013] _The MTA logo, consisting of the letters "MTA" in white inside a black circle._
[p027_c0014] _The "BETTERBUSES" logo, with "BETTER" in blue and "BUSES" in green._
[p027_c0015] _A smaller version of the New York City DOT logo._
