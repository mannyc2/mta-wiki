...
record_id: "source_flatbush-ave-cb2-jun2025"
record_kind: "source"
display_name: "Flatbush Ave Bus Priority - Presentation to Community Board 2"
source_id: "flatbush_ave_cb2_jun2025"
source_ids:
  - "flatbush_ave_cb2_jun2025"
local_observation_id: "source_flatbush_ave_cb2_jun2025"
local_observation_ids:
  - "source_flatbush_ave_cb2_jun2025"
review_state: "unreviewed"
truth_status: "source_stated"
generated_at: "2026-06-19T18:34:35.344Z"
submission_ids:
  - "sub_0183a4e7050c9139"
payload:
  authority_tier: "board_material"
  content_type: "presentation"
  date_text: "June 5, 2025"
  date_text_normalized:
    confidence: "parsed_text"
    normalized_date: "2025-06-05"
    precision: "day"
    raw_text: "June 5, 2025"
  description: "Presentation to Community Board 2 Transportation & Public Safety Committee about bus priority improvements on Flatbush Avenue, including center-running bus lanes"
  published_date_normalized: "2025-06-05"
...
evidence_refs:
  -
    block_id: "p001_c0001"
    evidence_id: "flatbush_ave_cb2_jun2025#p001_c0001"
    page_number: 1
    role: "title"
    source_id: "flatbush_ave_cb2_jun2025"
  ...
  -
    block_id: "p001_c0002"
    evidence_id: "flatbush_ave_cb2_jun2025#p001_c0002"
    page_number: 1
    role: "audience"
    source_id: "flatbush_ave_cb2_jun2025"
    source_path: "raw/sources/flatbush_ave_cb2_jun2025/blocks.jsonl"
    text_sha256: "sha256:faf1138197a1c92f5448369037297da1154b379281f739f6c5099f25ddeb4b1a"
    text_source: "raw_text"
  -
    block_id: "p001_c0003"
    evidence_id: "flatbush_ave_cb2_jun2025#p001_c0003"
    page_number: 1
    role: "date"
    source_id: "flatbush_ave_cb2_jun2025"
    source_path: "raw/sources/flatbush_ave_cb2_jun2025/blocks.jsonl"
    text_sha256: "sha256:c80f5854811d0750ae2aa77891c80d79f0607d3a00d37e4956d6c7bf015addea"
    text_source: "raw_text"
---

# Flatbush Avenue Bus Priority - presented to Brooklyn Community Board 2 in June 2025 (pdf)

source_id: flatbush_ave_cb2_jun2025
citation: cite block ids exactly as shown in square brackets
document: 209 block(s)

## Page 1

### [p001_c0001] Flatbush Ave Bus Priority
[p001_c0002] Presentation to Community Board 2 Transportation & Public Safety Committee
[p001_c0003] June 5, 2025
> [p001_c0004] A photograph of a blue MTA bus (B41 Limited) stopped at a bus stop on Flatbush Ave. The bus is numbered 7963. People are waiting at the stop, and a white van is visible in the background. The scene is set in an urban area with buildings and trees. The bus has 'B41 LIMITED' displayed on its destination sign and '7963' on its front. The bus stop sign indicates directions for B41 and B69 to Kings Plaza/Bergen Beach and Downtown Brooklyn, and B41 to Flatbush Av & Park Pl. A map is also visible on the stop pole.
[p001_c0005] _BETTERBUSES_
[p001_c0006] _NEW YORK CITY DOT_
...
[p002_c0006] _The NEW YORK CITY DOT logo, with 'NEW YORK CITY' above 'DOT' and a stylized 'DOT' graphic below._
...
- [p004_c0002] • 132,000 daily riders on 12 bus routes where buses often crawl at speeds as slow as 4 mph • 59% of households with no access to a private vehicle • Buses primarily serve Black, female, and low-income workers (Pratt Center Study) • Over half of workers—51%—reported being reprimanded, docked pay, or even fired due to bus service delays (Pratt Center Study) • Nearly 40% of all B41 trips start, end, or travel through the project area. Of those B41 trips, 80% begin or end south of Grand Army Plaza • Flatbush Ave identified in NYC Streets Plan as a Bus Priority Corridor
> [p004_c0003] A photograph of a busy urban bus stop. A blue MTA bus, labeled 'B41 LIMITED' and '7963', is stopped at a curb. Several people are waiting to board, including a man in a white t-shirt and backpack, a woman in a blue beanie, and a woman in a black dress. To the left, a green bus stop signpost displays route information for B41, B69, and Flatbush Ave & Park Pl. In the background, a white van and other vehicles are visible on the street. The scene is set in a city with buildings and trees in the distance.
[p004_c0004] _4_
[p004_c0005] _The logo for the Metropolitan Transportation Authority (MTA), featuring the letters 'MTA' in a stylized font inside a circle._
[p004_c0006] _The logo for 'BETTERBUSES', with the word 'BETTER' in blue and 'BUSES' in green, separated by a stylized graphic._
[p004_c0007] _The logo for the New York City Department of Transportation (NYC DOT), featuring the text 'NEW YORK CITY' above 'DOT' and a stylized graphic of a road or bridge._

## Page 5

> [p005_c0001] A photograph of a busy city street in Flatbush, Brooklyn, during the day. In the foreground, a dark blue Mazda CX-5 is driving towards the viewer in the left lane. To its right, a red Coldstone Catering truck is driving away, followed by a dark red Toyota Land Cruiser SUV. The street is lined with various commercial buildings, including a 'CLEANERS' shop, a 'NO JUDGMENT NO LIMITS' sign, and a 'FLAVOR TA' shop. A traffic light is visible above the intersection, showing a green light. Pedestrians are walking on the sidewalk to the right. The street has white lane markings and a 'ONE WAY' sign. In the background, there are more buildings and trees.
...
[p007_c0002] New pedestrian spaces and shorter crossing distances to improve safety and comfort
...
> [p009_c0003] A map of the Flatbush Avenue corridor in Brooklyn, New York. The map highlights the project extent from Livingston Street to Grand Army Plaza. The route is marked with a thick line that is blue from Livingston Street to Atlantic Avenue, green from Atlantic Avenue to Linden Blvd, and orange from Linden Blvd to Avenue U. Key streets and landmarks labeled include Atlantic Ave, Eastern Pkwy, Empire Blvd, Linden Blvd, Avenue D, Kings Hwy, Flatlands Ave, and Nostrand Ave. The map also shows the surrounding areas, including Long Island to the east, Lower New York Bay to the south, and Upper New York Bay to the west.
[p009_c0004] _9_
...
> [p011_c0006] A man wearing a white helmet, a blue t-shirt, and shorts with a white star pattern on a blue background is standing next to a green delivery van. He is holding a bicycle. Two other men, one in a green polo shirt and one in a grey t-shirt and yellow hard hat, are standing near the van. The van has "NEW YORK" printed on its side. They are under a green canopy on a city street.
> [p011_c0007] A person in a wheelchair is on a city street. A man in a black jacket and a white cap is standing next to the wheelchair. In the background, there is a bus stop with a purple sign that lists bus numbers 841, 841s, 845, 867, and 8103. The street is lined with tall buildings and there are cars parked along the curb.
[p011_c0008] _11_
[p011_c0009] _The MTA logo, which consists of the letters "MTA" in a bold, sans-serif font inside a black circle._
[p011_c0010] _The logo for "BETTERBUSES", with "BETTER" in blue and "BUSES" in green, separated by a stylized blue and green graphic._
[p011_c0011] _The logo for the New York City Department of Transportation (NYC DOT), featuring the text "NEW YORK CITY" above a stylized "DOT" logo._
...
> [p013_c0003] E. Gun Hill Rd, Bronx
...
[p013_c0008] _NEW YORK CITY DOT_
...
> [p018_c0002] Curbside Lane General Travel Lane Bus Boarding Islands at Bus Stops Center-Running Bus Lanes General Travel Lane Bus Only Bus Only Bus Only New pedestrian spaces with shorter crossing distances and refuge spaces Bus islands create near level boarding, making the bus easier to access with a more defined station-like area
[p018_c0003] _18_
...
[p019_c0003] Long crossing distances
[p019_c0004] Traffic congestion
[p019_c0005] _19_
...
[p020_c0002] Curbside Parking/Loading, Curb Extension
[p020_c0003] General Travel Lane
[p020_c0004] Center-Running Bus Lanes
[p020_c0005] General Travel Lane
[p020_c0006] Curbside Parking/Loading, Curb Extension
[p020_c0007] Painted curb extensions add pedestrian space and calm traffic at intersections to increase safety
[p020_c0008] Opportunities for greenery in curb extensions with maintenance partners
[p020_c0009] Center-running bus lanes allow buses to move freely without conflicts with traffic or double-parked vehicles
[p020_c0010] _20_
...
- [p024_c0002] • Dedicated center-running bus lanes minimize conflicts between buses and double-parked vehicles • Curb access remains essential to support Flatbush's small business commercial strip, between Dean St and Grand Army Plaza, and ensures businesses can continue to operate efficiently. • DOT is identifying locations for Truck Loading Zones on side street spurs so businesses can maintain loading access, with careful attention to safety, street design, and neighborhood context. • Where the parking lane is maintained, short-term parking and loading zones will be designated to improve turnover and access for customers and deliveries. • Between Dean St and Grand Army Plaza, peak period No Standing regulations would be replaced with new loading or parking where feasible.
[p024_c0003] _24_
...
> [p025_c0003] A map of Flatbush Avenue and its surrounding areas in Brooklyn. A red line indicates the northbound route on Flatbush Avenue, starting from a purple dot at the intersection of Dean St and Bergen St. Four blue arrows point north from the top of the map, indicating the direction of travel. The map is divided into four shaded regions with percentages: 26% (top, light blue), 7% (middle left, light blue), 10% (middle right, light blue), and 6% (bottom right, light blue). A blue callout box with a pointer to the purple dot contains the text: "Top routes used by all vehicles traveling northbound on Flatbush Ave between Dean St & Bergen St". Below the map, the text "Flatbush Ave Northbound Destinations" is written. Destination Percentage Manhattan 33% Lower Manhattan 7% Boroughs outside of Manhattan or out of the city entirely 30% Southbound travel ~24% of Flatbush Ave roadway users
[p025_c0004] _25_

## Page 26

### [p026_c0001] Making It Work: Future Travel Patterns
- [p026_c0002] • DOT has undertaken an extensive traffic analysis that looked at Flatbush Ave, nearby streets, and regional patterns • A reimagined Flatbush Ave will not have room for as many private vehicles as use the roadway today • DOT expects that with the new design: • Some drivers to/from Downtown Brooklyn will shift to faster, more reliable bus service • Some car trips to/from Manhattan will switch to alternate routes or transit service • Some local car traffic may shift to regional and adjacent corridors , which DOT will continue to monitor and manage
> [p026_c0003] A map of Brooklyn, New York, illustrating proposed alternate northbound routes for Flatbush Avenue. The map shows the city's street grid, including Flatbush Avenue, Prospect Avenue, Gowanus Avenue, and the Belt Parkway. Several routes are highlighted with white lines and labels: BBT (Brooklyn-Bathtub Tunnel), BKB (Brooklyn-Kingsboro Bridge), BQE (Brooklyn-Queens Expressway), WBB (Westchester Bay Bridge), Bedford Avenue, Rogers Avenue, Prospect Avenue, Gowanus Avenue, Ocean Parkway, and Belt Parkway. The map also shows the locations of New York City and the City of New York. The title 'Alternate Northbound Routes' is located at the bottom of the map.
[p026_c0004] _26_
[p026_c0005] _MTA_
...
> [p028_c0003] A photograph of a city street scene in Brooklyn. In the background, there are several tall, multi-story buildings. To the right, a large, modern building with a distinctive red, tiered roof is visible. The street is filled with cars, including a white van and a dark blue SUV. Pedestrians are walking on the sidewalks and crossing the street. The sky is clear and blue.
> [p028_c0004] A photograph of a busy city street intersection in Brooklyn. In the foreground, a wide crosswalk with white stripes is visible. Several cars are stopped or moving through the intersection, including a white van and a dark blue SUV. Pedestrians are crossing the street, including a person in a white shirt and shorts and another person in a black shirt and red shorts. The street is lined with buildings, and a traffic light is visible on the left. The overall scene is a typical urban environment.
[p028_c0005] _28_
...
[p028_c0008] _The NEW YORK CITY DOT logo, which includes the text "NEW YORK CITY" above the "DOT" logo, which is a stylized representation of the letters "DOT" in a grid-like pattern._
