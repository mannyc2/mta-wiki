...
record_id: "source_b44-sbs-progress-report-2016"
record_kind: "source"
display_name: "source_b44_sbs_progress_report_2016"
...
generated_at: "2026-06-08T19:51:21.404Z"
submission_ids:
  - "sub_27a852fbc11540a1"
payload:
  ...
  document_date_normalized:
    ...
    precision: "month"
    raw_text: "2016-06"
  published_date_normalized: "2016-06"
  published_date_precision: "month"
  publisher: "New York City Transit / NYC DOT"
  source_title: "B44 Select Bus Service Nostrand Avenue Progress Report"
  source_url: "https://www.nyc.gov/html/brt/downloads/pdf/brt-nostrand-progress-report-june2016.pdf"
evidence_refs:
  -
    block_id: "p001_c0001"
    evidence_id: "b44_sbs_progress_report_2016#p001_c0001"
    page_number: 1
    role: "title"
    source_id: "b44_sbs_progress_report_2016"
  ...
  -
    block_id: "p001_c0002"
    evidence_id: "b44_sbs_progress_report_2016#p001_c0002"
    page_number: 1
    role: "title"
    source_id: "b44_sbs_progress_report_2016"
    source_path: "raw/sources/b44_sbs_progress_report_2016/blocks.jsonl"
    text_sha256: "sha256:91456825ee7e456acb7c25fd89106d1e7f684dda7d7ba232a8099663e140eb2e"
    text_source: "raw_text"
  -
    block_id: "p001_c0003"
    evidence_id: "b44_sbs_progress_report_2016#p001_c0003"
    page_number: 1
    role: "title"
    source_id: "b44_sbs_progress_report_2016"
    source_path: "raw/sources/b44_sbs_progress_report_2016/blocks.jsonl"
  ...
  -
    block_id: "p001_c0004"
    evidence_id: "b44_sbs_progress_report_2016#p001_c0004"
    page_number: 1
    role: "publisher"
    source_id: "b44_sbs_progress_report_2016"
    source_path: "raw/sources/b44_sbs_progress_report_2016/blocks.jsonl"
  ...
  -
    block_id: "p038_c0002"
    evidence_id: "b44_sbs_progress_report_2016#p038_c0002"
    page_number: 38
...
# B44 Select Bus Service Nostrand Avenue Progress Report

source_id: b44_sbs_progress_report_2016
citation: cite block ids exactly as shown in square brackets
document: 325 block(s)
...
[p003_c0003] 5 Executive Summary 6 Introduction Select Bus Service The B44 Bus Route Issues Project Goals 10 Project Planning Public Outreach Merchant Survey Shopper Survey Service Planning & SBS Station Locations Traffic Planning & Street Design 18 B44 Select Bus Service Elements Bus Lanes Stations & Customer Information Off-board Fare Collection Pedestrian Improvements 22 Implementation Construction Project Launch 24 Project Results Bus Travel Time Bus Delay Customer Satisfaction Bus Ridership Traffic Patterns General Traffic Travel Time Safety 34 Next Steps Speeding Mitigation Washington Plaza Reconstruction Additional Real-Time Bus Arrival Signs
[p003_c0004] _3_

## Page 4

### [p004_c0001] Executive Summary
> [p004_c0002] A photograph of a New York City MTA bus, route B44, stopped at a bus stop. The bus is blue and white with the number 5325 on the front. The destination sign above the windshield displays 'B44' and '+SELECT BUS SERVICE+'. The bus is positioned on a street with a red 'STOP' marking painted on the pavement. Several people are waiting at the bus stop on the left. The background shows a city street with trees and buildings.
[p004_c0003] _4_
...
[p011_c0009] _10-04-2011 Public Open House_
...
> [p013_c0006] Location Walked from home Bus Subway Car - Not parked on SBS Street Car - Parked on SBS Street Car service Other Glenwood Rd 37% 30% 18% 8% 3% 2% Church Ave 52% 18% 16% 6% 5% 2% Empire Blvd 64% 11% 10% 6% 9% Fulton St 51% 20% 21% 3% 2% 2% 2% Percentages <2% not labeled
...
> [p014_c0002] The map illustrates the B44 SBS Project Corridors in Flatbush, Brooklyn. The routes are shown as follows: B44 SBS Route: Represented by a thick dark blue line with white circles containing a plus sign (+) indicating stops. It runs along Bedford, Rogers, and Nostrand Avenues. B44 Local & Former Limited Route: Represented by a light blue line with white circles containing a plus sign (+) indicating stops. It runs along Nostrand Avenue. Former B44 LTD stop: Represented by a white circle with a blue outline. Bus Lane: Represented by a thick red line. Subway Routes: Represented by thin grey lines. LIRR Station: Represented by a black square. Key landmarks and streets shown include: Streets: Taylor St, Hewes St, Flushing Av, Dekalb Av, Gates Av, Lafayette Av, Fulton St, St. John's Pl, Empire Blvd, Clarkson Av, Church Av, Newkirk Av, Farragut Rd, Flatbush Av, Ave D, Ave L, Kings Hwy, Ave U, Ave X, Shore Pkwy, Emmons Av, Knapp St. Parks and Cemeteries: Prospect Park, Greenwood Cemetery, Holy Cross Cemetery. Other: WBB Bus Plaza, South Williamsburg, Bedford Stuyvesant, Crown Heights, Lefferts Gardens, Flatlands, Flatbush, Midwood, Flatbush Av, Ave D, Ave L, Ave U, Ave X, Shore Pkwy, Emmons Av, Knapp St.
...
> [p016_c0003] The diagram shows a street cross-section with four lanes. From left to right, the lanes are: a 10' wide 'Peak Period Travel / Off-Peak Parking' lane, a 10' wide 'Travel Lane', a 10' wide 'Travel Lane', and a 10' wide 'Parking Lane'. The total width is 40'. Vehicles shown include a car, a bus, a car, and a truck. Pedestrians and a dog are also present on the sidewalks.
### [p016_c0004] Post-implementation
> [p016_c0005] The diagram shows a street cross-section with four lanes. From left to right, the lanes are: a 9' wide 'Parking Lane', an 11' wide 'SBS' bus lane (highlighted in red), a 10' wide 'Travel Lane', and a 10' wide 'Peak Period Travel / Off-Peak Parking' lane. The total width is 40'. Vehicles shown include a truck, a bus, a car, and a car. Pedestrians and a dog are also present on the sidewalks.
...
> [p017_c0007] A photograph of a city street scene, likely Nostrand Avenue and Martense Street, showing trucks accessing the curb. The street is lined with brick buildings, and several trucks are visible, including a large red truck with a 'CREME-IN-DOSE' advertisement and a white box truck. Cars are also visible on the street, and the sidewalk is paved with cobblestones. The sky is overcast.
[p017_c0008] _Trucks accessing the curb at Nostrand Avenue and Martense Street (post-implementation)_
[p017_c0009] _17_
...
> [p021_c0002] This map illustrates the B44 Select Bus Service (SBS) route in Queens, New York. The route is depicted as a thick dark blue line, with red lines indicating the specific bus lanes. The map shows the route running north-south, primarily between Bedford Avenue and Rogers Avenue. Key streets and landmarks are labeled, including Flushing Av, Park Av, DeKalb Av, Kosciusko St, Lafayette Av, Gates Av, Halsey St, Fulton St, Herkimer St, St. John's Pl, Lincoln Pl, Empire Bl, Sterling St, Parkside Av, Clarkson Av, Martense St, Church Av, Avenue D, and Newkirk Av. Other major roads shown include Broadway, Atlantic Av, Eastern Pkwy, Linden Blvd, Flatbush Av, Ocean Pkwy, and Nostrand Av. Parks are indicated by light green shaded areas. A legend in the bottom right corner defines the symbols: green circles for Bus Bulbs, orange squares for Neckdowns, red lines for Bus Lanes, dark blue lines for the B44 SBS Route, and light green for Parks. Legend: Bus Bulbs (Green Circle) Neckdowns (Orange Square) Bus Lanes (Red Line) B44 SBS Route (Dark Blue Line) Parks (Light Green Area)
...
> [p022_c0007] The diagram shows a timeline from Fall 2011 to Winter 2015. Key milestones include: Final Design (Fall 2011), Contract Bidding (Spring 2012), Surface Construction (Summer 2013), Start of SBS Service (Fall 2013), and SBS Service Operating (Winter 2013 onwards). Below this, the Nostrand Avenue Reconstruction timeline shows: Utility Work (Fall 2011), Subsurface Construction (Spring 2012 to Summer 2014), and Surface Construction (Fall 2014 to Winter 2015). Fall 2011 Winter 2011 Spring 2012 Summer 2012 Fall 2012 Winter 2012 Spring 2013 Summer 2013 Fall 2013 Winter 2013 Spring 2014 Summer 2014 Fall 2014 Winter 2014 Spring 2015 Summer 2015 Fall 2015 Winter 2015 SBS Construction on Nostrand Avenue south of Atlantic Avenue, and on Bedford and Rogers Avenues Final Design Contract Bidding Surface Construction Start of SBS Service SBS Service Operating Nostrand Avenue Reconstruction: Flushing Avenue to Atlantic Avenue Utility Work Subsurface Construction Surface Construction
[p022_c0008] _B44 SBS Project Implementation Timeline_
> [p022_c0009] A photograph showing a street scene on Rogers Avenue with a bus lane being painted. Workers in high-visibility vests are visible, and a bus is partially visible in the background.
[p022_c0010] _Bus lane painting on Rogers Avenue_
> [p022_c0011] A photograph showing a construction site on Rogers Avenue at Parkside Avenue. A bus bulb is being installed, surrounded by orange traffic cones and construction equipment. A street sign for Parkside Avenue is visible.
...
> [p024_c0010] Period Direction Pre-SBS (min) Post-SBS (min) % Change 6 AM - 10 AM Northbound 89 61.2 31% Southbound 77.7 62.6 19% 3 PM - 7 PM Northbound 83.1 66.7 20% Southbound 82.9 70.1 15% Entire route travel time change before and after SBS
[p024_c0011]
...
```
[p024_c0012] _B44 travel time change by segment_
[p024_c0013] _24_
...
[p026_c0008] Beginning in May 2013 and continuing through September 2014, ridership remained lower than the year before, with the largest dip in ridership occurring between October 2013 and February 2014. This decrease in ridership can be attributed to major corridor construction and the resulting slowdowns, customers adjusting to the new service, and the unusually bad winter in late
### [p026_c0009] Average Weekday Ridership Change by Month (% Change from One Year Before)
> [p026_c0010] The chart displays the percentage change in average weekday ridership from one year to the next for B44 Total and Brooklyn (BK) local buses from January 2012 to December 2015. The y-axis ranges from -25% to 50% in 5% increments. The x-axis shows months from 1 to 12 for each year. Two shaded regions highlight specific periods: a grey region from January 2012 to December 2013 labeled 'Period of Major Corridor Construction', and a blue region from January 2013 to December 2014 labeled 'First Year of SBS Service'. Within the blue region, text indicates 'B44 Total: 35,798' and 'BK locals: 620,141'. The B44 Total line shows a significant dip to approximately -18% in early 2014, while the BK locals line remains relatively stable, fluctuating between -5% and 5%. Approximate data points from the chart Month B44 Total (%) BK locals (%) 2012 Jan 10 8 2012 Feb 0 0 2012 Mar 0 0 2012 Apr 1 1 2012 May 0 0 2012 Jun -1 -1 2012 Jul -2 -2 2012 Aug -1 -1 2012 Sep 0 0 2012 Oct 0 0 2012 Nov 0 0 2012 Dec 0 0 2013 Jan -1 -1 2013 Feb -10 -10 2013 Mar -18 -15 2013 Apr -10 -5 2013 May -5 -2 2013 Jun -4 -1 2013 Jul -3 -1 2013 Aug -3 -1 2013 Sep -3 -1 2013 Oct -10 -5 2013 Nov -15 -10 2013 Dec -18 -12 2014 Jan -18 -10 2014 Feb -18 -10 2014 Mar -10 -5 2014 Apr -5 -2 2014 May -2 -1 2014 Jun -2 -1 2014 Jul -2 -1 2014 Aug -2 -1 2014 Sep -2 -1 2014 Oct -2 -1 2014 Nov 0 0 2014 Dec 8 2 2015 Jan 6 1 2015 Feb 5 0 2015 Mar 2 -2 2015 Apr 5 0 2015 May 4 -1 2015 Jun 3 -1 2015 Jul 3 -1 2015 Aug 2 -1 2015 Sep -2 -5 2015 Oct 0 -2 2015 Nov 4 0 2015 Dec 2 0
...
> [p028_c0009] Stop Location Time Period B44 Limited/SBS B44 Local B49 Total Avenue D Stops Pre-SBS 903 288 139 1330 May 2014 556 415 61 1032 May 2015 749 420 72 1241 Church Avenue Stops Pre-SBS 1026 544 277 1847 May 2014 722 700 209 1631 May 2015 1007 683 326 2016 Legend: ■ B44 Limited/SBS ■ B44 Local ■ B49
...
> [p029_c0009] Time Point Rogers Av-St Johns Pl Rogers Av-Empire Bl Rogers Av-Clarkson Av Rogers Av-Church Av Rogers Av-Av D Total Ridership September 2009 ~100 ~100 ~100 ~100 ~100 1,305 November 2011 ~80 ~80 ~80 ~80 ~80 1,106 February 2013 ~60 ~60 ~60 ~60 ~60 760 May 2014 ~40 ~40 ~40 ~40 ~40 487 October 2014 ~40 ~40 ~40 ~40 ~40 525 May 2015 ~50 ~50 ~50 ~50 ~50 665 October 2015 ~50 ~50 ~50 ~50 ~50 699 Legend: ROGERS AV-ST JOHNS PL (light blue), ROGERS AV-EMPIRE BL (dark blue), ROGERS AV-CLARKSON AV (grey), ROGERS AV-CHURCH AV (medium blue), ROGERS AV-AV D (dark grey)
[p029_c0010] _29_
...
> [p030_c0006] A. AM Peak: 7:45 - 8:45 AM Street Before Implementation Traffic Volumes After Implementation Traffic Volumes Change Washington Av +55 +55 +55 Bedford Av -61 -61 -61 Brooklyn Av -18 -18 -18 Rogers Av -114 -114 -114 Nostrand Av -146 -146 -146 Lenox Rd -27 -27 -27 Linden Bl -52 -52 -52
> [p030_c0007] B. PM Peak: 5:15 - 6:15 PM Street Before Implementation Traffic Volumes After Implementation Traffic Volumes Change Washington Av +69 +69 +69 Bedford Av +99 +99 +99 Brooklyn Av +50 +50 +50 Rogers Av -91 -91 -91 Nostrand Av -141 -141 -141 Lenox Rd -64 -64 -64 Linden Bl -172 -172 -172
...
> [p031_c0002] A. AM Peak: 7:45 - 8:45 AM Street Before Implementation After Implementation St. Johns Pl -45 -46 Flatbush Av +27 +52 Washington Av -146 -146 Bedford Av -146 -146 Rogers Av -537 -537 Nostrand Av -90 -90 New York Av +32 +32 Empire Bl -84 -84 Kingston Av -84 -84
> [p031_c0003] B. PM Peak: 5:15 - 6:15 PM Street Before Implementation After Implementation St. Johns Pl -15 -17 Flatbush Av -19 +28 Washington Av -92 -92 Bedford Av -92 -92 Rogers Av -118 -118 Nostrand Av -2 -2 New York Av -37 -37 Empire Bl -10 -10 Kingston Av -10 -10
...
> [p031_c0009] Peak Period Direction Pre-SBS (min) Post-SBS (min) Change (%) AM Peak (7:45 - 8:45 AM) Northbound 19.0 19.8 4% Southbound 21.8 21.5 2% PM Peak (5:15 - 6:15 PM) Northbound 18.3 16.7 9% Southbound 21.8 22.6 4% Legend: ■ Pre-SBS ■ Post-SBS
...
> [p032_c0004] A. AM Peak: 7:45 - 8:45 AM SB Speeds Up 2% North of Flatbush NB Speeds Down 4% North of Flatbush NB Speeds Down 7% South of Flatbush SB Speeds Up 2% South of Flatbush Speed (MPH) Change Greater than -2.5 -2.5 to -.5 -.5 to .5 .5 to 2.5 Greater than 2.5 Signal Mitigations Bus Lane NB SB Map labels: FLUSHING AV, LAFAYETTE AV, FULTON ST, ST. MARKS AV, EASTERN PKWY, EMPIRE BLVD, CLARKSON AV, CHURCH AV, NEWKIRK AV, AVENUE I, AVENUE S, AVENUE Z, EMMONS AV, MYRTLE AV, GATES AV, ATLANTIC AV, STERLING PL, CARROLL ST, MIDWOOD ST, LINDEN BLVD, BEVERLY RD, FARRAGUT RD, AVENUE M, AVENUE P, AVENUE V, BELT PKWY.
...
> [p033_c0004] B. PM Peak: 5:15 - 6:15 PM FLUSHING AV LAFAYETTE AV FULTON ST ST. MARKS AV EASTERN PKWY EMPIRE BLVD CLARKSON AV CHURCH AV NEWKIRK AV AVENUE I FLATBUSH AV AVENUE M AVENUE P KINGS HWY AVENUE S AVENUE V AVENUE Z FMMONS AV MYRTLE AV GATES AV ATLANTIC AV STERLING PL CARROLL ST MIDWOOD ST LINDEN BLVD BEVERLY RD FARRAGUT RD NB SB NB Speeds Up 10% North of Flatbush SB Speeds Down 4% North of Flatbush NB Speeds Down 1% South of Flatbush SB Speeds Up 1% South of Flatbush Speed (MPH) Change Greater than -2.5 -2.5 to -.5 -.5 to .5 .5 to 2.5 Greater than 2.5 Signal Mitigations Bus Lane
[p033_c0005] _33_
...
> [p038_c0001] An abstract graphic design featuring a light blue background with a grid of faint, light blue plus signs. The background is divided into three horizontal bands of varying shades of blue. A dark blue band at the top contains a row of plus signs. A medium blue band in the middle contains a grid of plus signs. A dark blue band at the bottom contains a row of plus signs. Overlaid on these bands are several large, semi-transparent, wavy shapes in shades of blue, creating a layered effect.
[p038_c0002] May 2016
