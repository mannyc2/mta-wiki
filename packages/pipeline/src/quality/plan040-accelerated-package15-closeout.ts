...
export const PLAN040_PACKAGE_15_POST_PERSISTENCE_PINS = {
  extent_ledger:
    "41b6b657babc2b7684a3d4d42c13fd1554f1e999b7a9e42cb8ee76b3c7af1fed",
  grain_ledger:
    "d4e84718a464f6aff86c990b77b97ff281b6cb3a4f9ee76bd7328a4e4aab10cf",
  bridge_ledger:
...
export const PLAN040_PACKAGE_15_EXTENT_VERDICT_HISTOGRAM = {
  ...
  "blocked_upstream:candidate_named_two_removed_one_added_not_isolatable_from_changed_id_diff":
    1,
  "blocked_upstream:candidate_specific_source_replay+staged_source_bytes": 5,
  "blocked_upstream:corrected_first_week_diff+corrected_first_week_full_stop_inventory+exact_stop_id_equivalence":
    1,
  "blocked_upstream:corrected_first_week_diff+corrected_first_week_full_stop_inventory":
    1,
  ...
  "blocked_upstream:effective_date_full_stop_inventory+exact_boarding_stop_identity+exact_stop_id_equivalence":
    1,
  "blocked_upstream:effective_date_full_stop_inventory+exact_stop_id_equivalence":
    1,
  ...
  "blocked_upstream:effective_date_full_stop_inventory+exact_stop_id_equivalence+revenue_trip_validation+route_specific_trip_pattern_binding":
    20,
  "blocked_upstream:effective_date_full_stop_inventory+peak_schedule_inventory":
    1,
  "blocked_upstream:exact_candidate_pattern_revenue_trip_validation+exact_schedule_to_gtfs_shape_identity":
    1,
  "blocked_upstream:exact_limited_variant_identity+schedule_trip_type_validation":
    1,
  "blocked_upstream:exact_predecessor_segment_attribution+schedule_trip_type_validation":
    1,
  ...
  "blocked_upstream:schedule_trip_type_validation": 1,
  "resolved:bounded_segment": 48,
  "resolved:route_wide": 35,
  "resolved:stop_set": 9,
} as const;
export const PLAN040_PACKAGE_15_GRAIN_VERDICT_HISTOGRAM = {
  absent_in_source: 165,
