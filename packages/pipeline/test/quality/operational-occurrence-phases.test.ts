...
describe("operational occurrence phase review v1", () => {
  ...
  it("pins the complete active 131-row corpus review and every generated byte", () => {
    ...
    expect(summary).toMatchObject({
      ...
      phase_identity_membership_count: 131,
      unique_phase_event_count: 131,
      reviewed_occurrence_count: 131,
      single_observed_phase_count: 131,
    ...
    expect(manifest).toMatchObject({
      ...
      route_anchor_release: {
        release_id: "v1-rc24",
        route_anchors: { path: "data/exports/releases/v1-rc24/route_anchors.jsonl" },
        operational_occurrences: {
          path: "data/exports/releases/v1-rc24/operational_occurrences.jsonl",
        },
      },
    });
