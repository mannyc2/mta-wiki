  ...
  it("pins the complete active 131-occurrence corpus review and every generated byte", () => {
    ...
    expect(manifest).toMatchObject({
      reproduction_command:
        "bun scripts/generate-operational-occurrence-phase-review-v1.ts --check --route-anchor-release-dir data/exports/releases/v1-rc28",
      route_anchor_release: {
        release_id: "v1-rc28",
        route_anchors: { path: "data/exports/releases/v1-rc28/route_anchors.jsonl" },
        operational_occurrences: {
          path: "data/exports/releases/v1-rc28/operational_occurrences.jsonl",
        },
      },
    });
