...
} from "@mta-wiki/pipeline/quality/plan040-qbnr-stop-removal-package4";
import {
...
import {
  acceptPlan040Package7DecisionPackage,
} from "@mta-wiki/pipeline/quality/plan040-qbnr-service-pattern-package7-closeout";
import {
...
import {
  acceptPlan040Package10aReceiptPackage,
} from "@mta-wiki/pipeline/quality/plan040-qbnr-service-pattern-package10a-closeout";
import {
  acceptPlan040Package10bDecisionPackage,
} from "@mta-wiki/pipeline/quality/plan040-qbnr-service-pattern-package10b-closeout";
import {
  writePlan040Package13Checkpoint,
} from "@mta-wiki/pipeline/quality/plan040-package13-checkpoint";
import {
...
const plan040Package4Accept: CommandHandler = () => {
  const result = acceptPlan040Package4ReceiptPackage();
  console.log(
    `Accepted Plan 040 Package 4 absence receipt: ` +
...
const plan040Package5Accept: CommandHandler = () => {
...
const plan040Package7Accept: CommandHandler = () => {
  const result = acceptPlan040Package7DecisionPackage();
  console.log(
    `Accepted Plan 040 Package 7 extent decisions: ${
  ...
  console.log(
    `Accepted Plan 040 Package 7 grain decisions: ${
  ...
  console.log(
    `Accepted Plan 040 Package 7 absence receipt: ${
      relative(repoRoot, result.absenceReceiptPath)
    }`,
  );
  console.log(
...
const plan040Package8Accept: CommandHandler = () => {
  const result = acceptPlan040Package8ReceiptPackage();
  console.log(
    `Accepted Plan 040 Package 8 absence receipt: ${
      relative(repoRoot, result.absenceReceiptPath)
    }`,
  );
  console.log(
...
const plan040Package10aAccept: CommandHandler = () => {
  const result = acceptPlan040Package10aReceiptPackage();
  console.log(
    `Accepted Plan 040 Package 10A absence receipt: ${
      relative(repoRoot, result.absenceReceiptPath)
    }`,
  );
  console.log(
...
const plan040Package10bAccept: CommandHandler = () => {
  const result = acceptPlan040Package10bDecisionPackage();
  console.log(
    `Accepted Plan 040 Package 10B extent decisions: ${
      relative(repoRoot, result.extentDecisionPath)
    }`,
  );
  console.log(
  ...
  console.log(
    `Accepted Plan 040 Package 10B grain decisions: ${
      relative(repoRoot, result.grainDecisionPath)
    }`,
  );
  console.log(
  ...
  console.log(
    `Accepted Plan 040 Package 10B absence receipt: ${
      relative(repoRoot, result.absenceReceiptPath)
    }`,
  );
  console.log(
...
const plan040Package13Checkpoint: CommandHandler = () => {
  const check = process.argv.includes("--check");
  const result = writePlan040Package13Checkpoint({ check });
  console.log(
    `Plan 040 Package 13 checkpoint ${check ? "verified" : "written"}: ` +
    `${relative(repoRoot, result.path)}`,
  );
  console.log(`SHA-256: ${result.sha256}`);
};

const plan040Package14Checkpoint: CommandHandler = () => {
  const check = process.argv.includes("--check");
  const result = writePlan040Package14Checkpoint({ check });
  console.log(
    `Plan 040 Package 14 checkpoint ${check ? "verified" : "written"}: ` +
    `${relative(repoRoot, result.path)}`,
  );
  console.log(`SHA-256: ${result.sha256}`);
};
...
export const qualityCommands = {
  ...
  "plan-040-package-10a-accept": plan040Package10aAccept,
